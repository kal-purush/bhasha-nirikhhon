...
{
    private readonly static float[][] PowerOutputTable = new float[][]
    {
    ...
    private readonly static float[] EnergyTable = new float[]
    {
    ...
    private static int _resistanceLevel = 1;
    public static int ResistanceLevel
    {
        get
        {
    ...
    private static int _speedLevel = 0;
    ...
    public static float CalculatePowerOutput(int rpm)
    {
        SpeedLevel = Mathf.RoundToInt(rpm * Ratio.RPMToSpeedLevel);
    ...
    public static int CalculateRPM()
    {
