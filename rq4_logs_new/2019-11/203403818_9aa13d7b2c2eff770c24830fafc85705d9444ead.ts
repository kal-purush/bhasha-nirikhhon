...
iframe.on("UpdateData", async () => {
  ...
  if (document.querySelector("#dogevideo_html5_api") !== null) {
    ...
    var video: HTMLVideoElement = document.querySelector("#video-player");
  ...
  } else if (document.querySelector("#player_container > div.jw-wrapper.jw-reset > div.jw-media.jw-reset > video") !== null) {
    var video: HTMLVideoElement = document.querySelector("#player_container > div.jw-wrapper.jw-reset > div.jw-media.jw-reset > video");
    ...
    var video: HTMLVideoElement = document.querySelector("#vplayer > div > div.container.pointer-enabled > video");
