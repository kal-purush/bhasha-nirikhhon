...
var _user$project$Inventory$Model = function (a) {
	return {dieFace: a};
};
var _user$project$Inventory$init = {
	ctor: '_Tuple2',
	_0: _user$project$Inventory$Model(1),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Inventory$NewFace = function (a) {
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'Roll') {
			return {
				...
				_1: A2(
					_elm_lang$core$Random$generate,
					_user$project$Inventory$NewFace,
					A2(_elm_lang$core$Random$int, 1, 6))
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: _user$project$Inventory$Model(_p0._0),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Inventory$Roll = {ctor: 'Roll'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Inventory$Roll)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Inventory$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Inventory$init, view: _user$project$Inventory$view, update: _user$project$Inventory$update, subscriptions: _user$project$Inventory$subscriptions})
};
