...
from server12.database import Base
from server12.crud import get_pair,create_pair
from server12.schemas import PairCreate, Pair
...
from server12.database import SessionLocal, engine
