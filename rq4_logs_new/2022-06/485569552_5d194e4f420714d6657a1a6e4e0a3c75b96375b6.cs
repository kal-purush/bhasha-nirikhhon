...
namespace Siapel.EF.Migrations
{
    ...
    [Migration("20220611023148_tabungbocortable")]
    partial class tabungbocortable
    {
            ...
            modelBuilder.Entity("Siapel.Domain.Models.Harga", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            PangkalanId = 1,
                            TanggalUbah = new DateTime(2022, 6, 11, 10, 31, 48, 366, DateTimeKind.Local).AddTicks(7309),
                            TbDuaBelas = 195000,
                            TbLimaPuluh = 1012000,
            ...
            modelBuilder.Entity("Siapel.Domain.Models.StokAwal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Item = "50 KG",
                            Jumlah = 20,
                            Tanggal = new DateTimeOffset(new DateTime(2022, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 8, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
