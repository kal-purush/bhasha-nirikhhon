...
namespace OtripleS.Web.Api.Migrations
{
    ...
    [Migration("20220614142703_AddMealsModel")]
    partial class AddMealsModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OtripleS.Web.Api.Models.Meals.Meal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OtripleS.Web.Api.Models.Registrations.Registration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OtripleS.Web.Api.Models.StudentRegistrations.StudentRegistration", b =>
                {
                    b.Property<Guid>("StudentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("StudentId", "RegistrationId");
            ...
            modelBuilder.Entity("OtripleS.Web.Api.Models.ExamFees.ExamFee", b =>
                {
                    b.HasOne("OtripleS.Web.Api.Models.Users.User", "CreatedByUser")
                        .WithMany("ExamFeesCreatedByUser")
            ...
            modelBuilder.Entity("OtripleS.Web.Api.Models.Registrations.Registration", b =>
                {
                    b.HasOne("OtripleS.Web.Api.Models.Users.User", "CreatedByUser")
                        .WithMany("RegistrationsCreatedByUser")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("OtripleS.Web.Api.Models.Users.User", "UpdatedByUser")
                        .WithMany("RegistrationsUpdatedByUser")
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("OtripleS.Web.Api.Models.StudentRegistrations.StudentRegistration", b =>
                {
                    b.HasOne("OtripleS.Web.Api.Models.Registrations.Registration", "Registration")
            ...
            modelBuilder.Entity("OtripleS.Web.Api.Models.Users.User", b =>
                {
                    b.Navigation("ExamFeesCreatedByUser");

                    b.Navigation("ExamFeesUpdatedByUser");

                    b.Navigation("FeesCreatedByUser");

                    b.Navigation("FeesUpdatedByUser");

                    b.Navigation("RegistrationsCreatedByUser");

                    b.Navigation("RegistrationsUpdatedByUser");
