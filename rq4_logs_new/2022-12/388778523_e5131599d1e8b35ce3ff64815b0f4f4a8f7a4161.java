...
package com.ibm.ws.jpa.tests.eclipselink.query.tests.jpa31;
...
import com.ibm.ws.jpa.jpa31.web.TestMathServlet;
...
public class TestJPA31_Web extends JPAFATServletClient {
    ...
    static {
        dropSet.add("JPA_JPA31_${provider}_DROP_${dbvendor}.ddl");
        createSet.add("JPA_JPA31_${provider}_CREATE_${dbvendor}.ddl");
    }

    @Server("EclipseLink31QueryServer")
    @TestServlets({
                    @TestServlet(servlet = TestMathServlet.class, path = CONTEXT_ROOT + "/" + "TestMathServlet")
    })
    ...
    public static void setUp() throws Exception {
        ...
        bannerStart(TestJPA31_Web.class);
        ...
        System.out.println(TestJPA31_Web.class.getName() + " Setting up database tables...");
    ...
    private static void setupTestApplication() throws Exception {
        ...
        webApp.addPackages(true, "com.ibm.ws.jpa.jpa31.model");
        webApp.addPackages(true, "com.ibm.ws.jpa.jpa31.testlogic");
        webApp.addPackages(true, "com.ibm.ws.jpa.jpa31.web");
    ...
    public static void tearDown() throws Exception {
        try {
            ...
            bannerEnd(TestJPA31_Web.class, timestart);
        }
    }
}