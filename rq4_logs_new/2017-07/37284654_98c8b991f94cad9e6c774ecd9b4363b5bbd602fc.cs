...
namespace Microsoft.ApplicationInsights
{
    public static class TelemetryClientExtensions
    {
        ...
        //{
        //    return GetMetric(telemetryClient, metricId);
        //}

        //public static Metric GetMetric(this TelemetryClient telemetryClient, string metricId, string dimensionName, IMetricConfiguration metricConfiguration)
        //{
