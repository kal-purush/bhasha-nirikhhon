...
namespace Vulnerator
{
    ...
    public partial class App : Application
    {
        ...
        {
            MessageBox.Show(@"The application has encountered an error; please notify the developer via the SoftwareForge site at https://software.forge.mil/ (PKI Enabled).", 
