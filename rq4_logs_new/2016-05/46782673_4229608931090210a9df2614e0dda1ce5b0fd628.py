...
datasets=('mc15_13TeV.387940.MGPy8EG_A14N23LO_TT_bWN_225_135_2L15.evgen.EVNT.e4898',
...
for dataset in datasets:
    ...
    print ''
    command=('pathena --trf "Reco_tf.py --inputEVNTFile=%%IN --outputDAODFile=output.pool.root --reductionConf TRUTH1" --inDS %s --outDS %s --extOutFile=DAOD_TRUTH1.output.pool.root' 
            % (dataset,dataset.replace('mc15_13TeV','user.amete').replace('evgen.EVNT','DAOD_TRUTH1')+str('.v2')))
    os.system(command)