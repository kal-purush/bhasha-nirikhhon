...
presence.on("UpdateData", async () => {
  ...
  if (pathname === "/") 
    ...
    data.details = "Creating a fundraiser";
   else if (pathname.includes("/discover")) 
    data.details = "Browsing Fundraiser";
   else if (pathname.includes("/start")) 
    data.details = "Starting a fundraiser";
   ...
   else if (pathname === "/c/cause/justice-and-equality" || pathname === "/c/cause/justice-and-equality/") {
    data.details = "GoFundMe Causes";
