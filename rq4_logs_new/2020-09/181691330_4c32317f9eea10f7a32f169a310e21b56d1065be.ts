...
export class intersolvebarcode1600870004754 implements MigrationInterface {
    name = 'intersolvebarcode1600870004754'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "121-service"."intersolve_barcode" ALTER COLUMN "timestamp" SET DEFAULT CURRENT_TIMESTAMP`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "121-service"."intersolve_barcode" ALTER COLUMN "timestamp" SET DEFAULT now()`);
