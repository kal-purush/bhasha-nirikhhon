...
class coord(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["x"] = _stream.coord_x_set
    __swig_getmethods__["x"] = _stream.coord_x_get
    if _newclass:
        x = _swig_property(_stream.coord_x_get, _stream.coord_x_set)
    __swig_setmethods__["y"] = _stream.coord_y_set
    __swig_getmethods__["y"] = _stream.coord_y_get
    if _newclass:
        y = _swig_property(_stream.coord_y_get, _stream.coord_y_set)
    __swig_setmethods__["z"] = _stream.coord_z_set
    __swig_getmethods__["z"] = _stream.coord_z_get
    if _newclass:
        z = _swig_property(_stream.coord_z_get, _stream.coord_z_set)

    def __init__(self):
        this = _stream.new_coord()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _stream.delete_coord
    __del__ = lambda self: None
coord_swigregister = _stream.coord_swigregister
...
class astats(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, astats, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, astats, name)
    __repr__ = _swig_repr
    __swig_setmethods__["nc"] = _stream.astats_nc_set
    __swig_getmethods__["nc"] = _stream.astats_nc_get
    if _newclass:
        nc = _swig_property(_stream.astats_nc_get, _stream.astats_nc_set)
    __swig_setmethods__["nf"] = _stream.astats_nf_set
    __swig_getmethods__["nf"] = _stream.astats_nf_get
    if _newclass:
        nf = _swig_property(_stream.astats_nf_get, _stream.astats_nf_set)

    def __init__(self):
        this = _stream.new_astats()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _stream.delete_astats
    __del__ = lambda self: None
astats_swigregister = _stream.astats_swigregister
astats_swigregister(astats)

class Adapt(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Adapt, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Adapt, name)
    __repr__ = _swig_repr
    __swig_setmethods__["slist"] = _stream.Adapt_slist_set
    __swig_getmethods__["slist"] = _stream.Adapt_slist_get
    if _newclass:
        slist = _swig_property(_stream.Adapt_slist_get, _stream.Adapt_slist_set)
    __swig_setmethods__["max"] = _stream.Adapt_max_set
    __swig_getmethods__["max"] = _stream.Adapt_max_get
    if _newclass:
        max = _swig_property(_stream.Adapt_max_get, _stream.Adapt_max_set)
    __swig_setmethods__["maxlevel"] = _stream.Adapt_maxlevel_set
    __swig_getmethods__["maxlevel"] = _stream.Adapt_maxlevel_get
    if _newclass:
        maxlevel = _swig_property(_stream.Adapt_maxlevel_get, _stream.Adapt_maxlevel_set)
    __swig_setmethods__["minlevel"] = _stream.Adapt_minlevel_set
    __swig_getmethods__["minlevel"] = _stream.Adapt_minlevel_get
    if _newclass:
        minlevel = _swig_property(_stream.Adapt_minlevel_get, _stream.Adapt_minlevel_set)
    __swig_setmethods__["list"] = _stream.Adapt_list_set
    __swig_getmethods__["list"] = _stream.Adapt_list_get
    if _newclass:
        list = _swig_property(_stream.Adapt_list_get, _stream.Adapt_list_set)

    def __init__(self):
        this = _stream.new_Adapt()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _stream.delete_Adapt
    __del__ = lambda self: None
Adapt_swigregister = _stream.Adapt_swigregister
Adapt_swigregister(Adapt)


def adapt_wavelet(p):
    return _stream.adapt_wavelet(p)
adapt_wavelet = _stream.adapt_wavelet
...
def conserve_elevation():
    return _stream.conserve_elevation()
conserve_elevation = _stream.conserve_elevation

u = vector(_stream.cvar.u)
eta = scalar(_stream.cvar.eta)
h = scalar(_stream.cvar.h)
zb = scalar(_stream.cvar.zb)
