namespace SMLHelper.V2.Commands
{
    ...
    /// <summary>
    /// Attribute used to signify the attributed method should be called in response to a console command.
    /// 
    /// <para>Attributed method must be both <see langword="public"/> and <see langword="static"/>.</para>
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// The unique, case-insensitive command that when entered, will call the attributed method.
        /// </summary>
        public string Command { get; }

        /// <summary>
        /// <para>Signifies the attributed method should be called when the given <paramref name="command"/> is entered
