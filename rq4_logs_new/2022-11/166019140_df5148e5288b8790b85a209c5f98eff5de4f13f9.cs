...
namespace SFA.DAS.Reservations.Domain.Reservations.Api
{
    public class GetTransferValidityRequest : IGetApiRequest
    {
        ...
        public string GetUrl => $"transfers/validity?senderId={_senderId}&receiverId={_receiverId}{(_pledgeApplicationId.HasValue ? $"&pledgeApplicationId={_pledgeApplicationId}" : string.Empty)}";
