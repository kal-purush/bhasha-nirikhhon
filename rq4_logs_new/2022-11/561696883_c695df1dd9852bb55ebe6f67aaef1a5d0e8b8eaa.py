...
def parse_args():
    ...
    parser.add_argument('--log', type=str, default='./log', help='root log directory')
    ...
    parser.add_argument('--wandb_name', type=str, default='training_SSAN_v2', help='name wandb project')
