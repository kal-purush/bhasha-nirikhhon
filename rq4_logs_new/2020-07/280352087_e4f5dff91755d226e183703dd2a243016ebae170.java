...
public class MyPair<FIRST extends Comparable<FIRST>, SECOND extends Comparable<SECOND>> implements Comparable<MyPair<FIRST, SECOND>> {
    ...
    MyPair<FIRST, SECOND> of(FIRST first, SECOND second) {
    ...
    public boolean equals(Object obj) {
        ...
        return equal(first, ((MyPair) obj).first)
                && equal(second, ((MyPair) obj).second);
    }
