...
interface mat4 {
  ...
  fromTranslation(out: Float32Array, v: ArrayOfNumber): Float32Array;
  fromScaling(out: Float32Array, v: ArrayOfNumber): Float32Array;
  fromRotation(out: Float32Array, rad: number, axis: ArrayOfNumber): Float32Array;
  ...
  lookAt(out: Float32Array, eye: ArrayOfNumber, center: ArrayOfNumber, up: ArrayOfNumber): Float32Array;
  str(a: Float32Array): string;
  frob(a: Float32Array): number;
}
