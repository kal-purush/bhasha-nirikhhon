 ...
 * @author emmakordik
 */
@WebServlet(name = "MessageServiceController", urlPatterns = {"/greeter"})
public class MessageServiceController extends HttpServlet {
    private final String validationMessage = "whoever you are";
    /**
