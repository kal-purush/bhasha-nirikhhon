...
import { BotsSubscription, BotsSubscriptionSchema } from './entities/bots.entity';
import { HttpModule } from '@nestjs/axios'; 

@Module({
  imports: [
    MongooseModule.forFeature([{ name: BotsSubscription.name, schema: BotsSubscriptionSchema }]),
    HttpModule, 
  ],
