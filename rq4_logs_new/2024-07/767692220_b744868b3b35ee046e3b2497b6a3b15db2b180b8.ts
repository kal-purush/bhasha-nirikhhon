...
import type {} from // ApiReg001RequestBody,
// ApiReg001ResponseCreated,
"@sparcs-clubs/interface/api/registration/endpoint/apiReg001";
...
export default class RegistrationController {
  ...
  // async postStudentRegistration(@Body() body: ApiReg001RequestBody) {
