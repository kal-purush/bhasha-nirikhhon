...
public class Weather implements Command {
    ...
    public void action(String[] args, MessageReceivedEvent event) throws Exception {
        ...
        com.github.prominence.openweathermap.api.model.response.Weather weatherResponse = weatherRequester
                ...
                .getByCityName(String.valueOf((args[1]).toUpperCase().contains(Cities.toUpperCase())));

        System.out.println((args.toString()).toUpperCase());

        if(!String.valueOf(args.length).contains(Cities)) {
