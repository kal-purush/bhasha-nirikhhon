package by.tms.lesson44_task1.configiration;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* by.tms.lesson44_task1.services.*Service.*(..))")
    public void services() {}

    @Pointcut("execution(* by.tms.lesson44_task1.repositories.*Repository.*(..))")
