    ...
    entities: {
        ...
        entity: [
            ...
            },
            {
                ...
                _exporttype: "SingleFolder",
                _fetchQueryParameters:
                    "?$filter=_objectid_value%20eq%20{entityId}%20&$select=mimetype,documentbody,filename,annotationid",
            ...
            },
            {
                ...
                _fetchQueryParameters:
                    "?$filter=adx_contentsnippetid%20eq%20{entityId}&$select=adx_name,adx_value,_adx_contentsnippetlanguageid_value",
