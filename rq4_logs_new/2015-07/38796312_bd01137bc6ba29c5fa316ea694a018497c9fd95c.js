...
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngValue');
bench.addTime(diff);
bench.benchExpression(attr.ngValue, diff);
});
        };
      }
    }
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngBind');
bench.addTime(diff);
bench.benchExpression(attr.ngBind, diff);
});
});
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngBindHtml');
bench.addTime(diff);
bench.benchExpression(attr.ngBindHtml, diff);
});
  };
}];
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngIf');
bench.addTime(diff);
bench.benchExpression($attr.ngIf, diff);
});
      };
    }
  };
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngInclude');
bench.addTime(diff);
bench.benchExpression($attr.ngInclude, diff);
});
      };
    }
  };
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngPluralize');
bench.addTime(diff);
bench.benchExpression(numberExp, diff);
});
    }
  };
}];
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngShow');
bench.addTime(diff);
bench.benchExpression(attr.ngShow, diff);
});
  };
}];
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngHide');
bench.addTime(diff);
bench.benchExpression(attr.ngHide, diff);
});
  };
}];
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngStyle');
bench.addTime(diff);
bench.benchExpression(attr.ngStyle, diff);
}, true);
});
...
var endTime = new Date().getTime();
var diff = endTime - startTime;
var bench = $NgBenchPageRecorder.getActiveRecord().bench('ngSwitch');
bench.addTime(diff);
bench.benchExpression(watchExpr, diff);
});
    }
  };
}];
