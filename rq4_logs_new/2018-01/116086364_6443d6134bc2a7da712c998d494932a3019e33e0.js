...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            if (params.nameTo) {
                this.nameTo = document.querySelector(params.nameTo);
            }
            if (params.valueTo) {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                var area_province = _self.gearArea.querySelector(".p_area_province");
                var area_city = _self.gearArea.querySelector(".p_area_city");
            ...
            function setGear(target, val) {
                ...
                if (_self.data) _self.setGearTooth(_self.data);
            }
        ...
        finish: function(e) {
            ...
            _self.trigger.innerHTML = provinceText + ((cityText) ? (',' + cityText) : (''));
            _self.value = [provinceVal, cityVal];
            if (this.nameTo) {
                this.nameTo.value = provinceText + ((cityText) ? (',' + cityText) : (''));
                $(this.nameTo).focus();
            }
            if (this.valueTo) {
