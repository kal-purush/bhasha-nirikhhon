...
export const EDITORSCHOICEAPPS: App[] = [
...
},
  {
    ...
    description: '',
    projectLicense: '',
    iconDesktopUrl: "https://code.visualstudio.com/assets/updates/1_17/mac-stable-orange.png",
    iconMobileUrl: "https://code.visualstudio.com/assets/updates/1_17/mac-stable-orange.png",
    homepageUrl: '',
    bugtrackerUrl: '',
    downloadFlatpakRefUrl: '',
    currentRelease: '',
