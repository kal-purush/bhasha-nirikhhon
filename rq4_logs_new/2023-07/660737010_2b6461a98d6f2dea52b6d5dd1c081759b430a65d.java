...
public class ExceptionAdvice {
    ...
    public ResponseEntity onKnownException(BaseException baseException,
        ...
        return new ResponseEntity<>(BaseResponse.onFailure(baseException.getStatus().getCode(), baseException.getResponseMessage(), baseException.getData()),
    ...
    public ResponseEntity onException(Exception exception, @AuthenticationPrincipal User user,
        ...
        return new ResponseEntity<>(BaseResponse.onFailure("500", exception.getMessage(), null), null,
