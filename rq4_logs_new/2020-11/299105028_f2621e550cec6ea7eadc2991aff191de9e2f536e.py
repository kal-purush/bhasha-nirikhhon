...
class ConvbertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers.ConvbertModel` or a
    :class:`~transformers.TFConvbertModel`. It is used to instantiate an ALBERT model according to the specified
