...
public class ChatUtil
{
    ...
    {
        sendChat(player, TextLocalizer.localizeAll(unlocLines));
    }
    ...
    {
        sendNoSpamClient(TextLocalizer.localizeAll(unlocLines));
    }
    ...
    {
        sendNoSpam(player, TextLocalizer.localizeAll(unlocLines));
    }
