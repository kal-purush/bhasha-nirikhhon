...
namespace GladNet.PhotonServer
{
	/// <summary>
	...
	/// </summary>
	public class PhotonRouteBackService : INetworkMessageRouteBackService, IClassLogger
	{
		/// <summary>
		...
		public PhotonRouteBackService(IAUIDService<INetPeer> peerCollection, ILog logger)
		{
