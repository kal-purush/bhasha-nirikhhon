...
public final class UrlConstants {
    ...
    public static final String API_OLD_PLAN_URL = METAL_ONLY_API_BASE_URL + "plan";
    ...
    public static final String METAL_ONLY_MODERATOR_PIC_BASE_URL = METAL_ONLY_API_BASE_URL + "pic&nick=";
}