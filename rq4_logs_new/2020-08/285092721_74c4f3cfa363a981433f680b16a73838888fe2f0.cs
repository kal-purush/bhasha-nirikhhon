...
#pragma warning disable SA1005
    ...
    /// </summary>
    public sealed class BasicQLearningStrategy : RandomStrategy
    {
        /// <summary>
        ...
        /// </summary>
        public BasicQLearningStrategy(AbstractionLevel abstractionLevel, string stateInfoCSV, int maxSteps, IRandomNumberGenerator random)
            : base(maxSteps, stateInfoCSV, random)
        {
            ...
            {
                this.StateInfoCSV += "/BasicQL.csv";
                var csv = new StringBuilder();
                var header = string.Format("Step,BasicQL_States");
        ...
        /// </summary>
        public override string GetDescription() => $"BasicQLearning[seed '{this.RandomNumberGenerator.Seed}']";
    }
