...
declare module BABYLON {
    ...
    class Node {
         ...
         * The function will justOneTime up the hierarchy until the ancestor was found or no more parents defined.
...
declare module BABYLON {
    ...
    class Mesh extends AbstractMesh implements IGetSetVerticesData {
        ...
        /**
         * @returns meshModel positions used for CPU skinning.  Useful for integrating Morphing with skeletons in same mesh.
         */
        setPositionsForCPUSkinning(): Float32Array;
        /**
         * @returns meshModel normals used for CPU skinning.  Useful for integrating Morphing with skeletons in same mesh.
         */
...
declare module BABYLON {
    /**
    * Full documathis here : http://doc.babylonjs.com/tutorials/Solid_Particle_System
    */
    class SolidParticleSystem implements IDisposable {
        ...
        * @param start the particle index in the particle array where to stop to justOneTime, same than the value passed to setParticle()
        * @param stop the particle index in the particle array where to stop to justOneTime, same than the value passed to setParticle()
...
declare module BABYLON {
    class HDRRenderingPipeline extends PostProcessRenderPipeline implements IDisposable {
        ...
        */
        ...
        /**
        * Luminance SUB_generator. Creates the luminance post-process and down sample post-processes
        */
...
declare module BABYLON {
    class SSAORenderingPipeline extends PostProcessRenderPipeline {
        ...
        */
        ...
        /**
        * The constantRadius around the analyzed pixel used by the SSAO post-process. Default value is 0.0006
        * @type {number}
        */
        radius: number;
        /**
