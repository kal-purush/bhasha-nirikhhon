...
public enum SoundUtils {
    ...
    private static Sound resolveSound = null;
    private String oldSound;
    private String newSound;

    SoundUtils(String oldSound, String newSound) {
        this.oldSound = oldSound;
        this.newSound = newSound;
    }

    public static SoundUtils getEnumSound(String sound) {
        String splittedSound = sound;
    ...
    public Sound resolveSound() {
        ...
        try {
            resolveSound = Sound.valueOf(oldSound);
        } catch (IllegalArgumentException exception) {
            resolveSound = Sound.valueOf(newSound);
        }
