...
public class MainScreen extends Application implements PerformerActions {
	...
	private Button btnAdocoes = new Button("Ado��es");
	private Button btnFuncionarios = new Button("Funcion�rios");
	private Button btnConfiguracoes = new Button("Configura��es");
