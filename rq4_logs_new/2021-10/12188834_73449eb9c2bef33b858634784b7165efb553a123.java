...
/*
 * Cornell Customization: backport FINP-7340 from the 2/11/2021 financials release. This can be removed when we upgrade to this release.
 */
public class CashControlDocument extends GeneralLedgerPostingDocumentBase implements AmountTotaling,
    ...
    protected void removeGeneralLedgerPendingEntries() {
        // In order for the GLPEs to be removed from the Cash Control Doc, they need to be cleared as well as deleted
        // otherwise they are recreated after the deletion.
        clearAnyGeneralLedgerPendingEntries();
        super.removeGeneralLedgerPendingEntries();
    }
