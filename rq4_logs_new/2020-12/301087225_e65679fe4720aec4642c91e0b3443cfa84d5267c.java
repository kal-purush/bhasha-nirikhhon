...
public class Pemrograman07 {
    public static void main(String[] args) {
        ...
        while(cek.equalsIgnoreCase("Y")){
            ...
            String input = mustika.next();
        if(input.equalsIgnoreCase("d")){
            int nomorFilm = mustika.nextInt() - 1;
            detailFilm(nomorFilm,movieFavourite);
            System.out.println("Y/N untuk melanjutkan daftar Film");
            cek = mustika.next();
        }
        else if(input.equalsIgnoreCase("a")){
            addFilm(movieFavourite,mustika);
            daftarFilm(movieFavourite);
            System.out.println("Y/N untuk melanjutkan daftar Film");
            cek = mustika.next();
        }
        else if(input.equalsIgnoreCase("r")){
            int deleteNumberOfFilm = mustika.nextInt() - 1;
    ...
    public static void addFilm(HashMap<String, ArrayList<String>> movieFavourite, Scanner mustika2){
        mustika2.nextLine();
        String judul;   String rilis;   String durasi;
        String genre;   String sinopsis;    String cast;

        System.out.println("Judul:"); judul = mustika2.nextLine();
        System.out.println("Rilis:"); rilis = mustika2.nextLine(); 
        System.out.println("Durasi:"); durasi = mustika2.nextLine();
        System.out.println("Genre:"); genre = mustika2.nextLine();
        System.out.println("Sinopsis:"); sinopsis = mustika2.nextLine();
        System.out.println("Cast:"); cast = mustika2.nextLine();
