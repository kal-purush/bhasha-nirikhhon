...
public class NotificationApiServiceTest extends AbstractAclTest {
    ...
    public void shouldCreateNotification() {
        doReturn(notificationMessage).when(mockNotificationManager).createNotification(notificationMessageVO);

        assertThat(notificationApiService.createNotification(notificationMessageVO)).isEqualTo(notificationMessage);
    }
}