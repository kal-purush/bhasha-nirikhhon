 ...
 */
@JacksonXmlRootElement(localName = "BlockBlob-PutBlobFromUrl-Headers")
@Fluent
public final class BlockBlobPutBlobFromUrlHeaders {
    /*
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setETag(String eTag) {
        this.eTag = eTag;
        return this;
    }
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setLastModified(OffsetDateTime lastModified) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setContentMD5(byte[] contentMD5) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setClientRequestId(String clientRequestId) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setRequestId(String requestId) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setVersion(String version) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setVersionId(String versionId) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setDateProperty(OffsetDateTime dateProperty) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setIsServerEncrypted(Boolean isServerEncrypted) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setEncryptionKeySha256(String encryptionKeySha256) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setEncryptionScope(String encryptionScope) {
     ...
     * @return the BlockBlobPutBlobFromUrlHeaders object itself.
     */
    public BlockBlobPutBlobFromUrlHeaders setErrorCode(String errorCode) {
