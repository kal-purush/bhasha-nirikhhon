...
public class PPNomor1 {
    ...
    public static void main(String[] args) {
        ...
        while(cek.equalsIgnoreCase("Y")){
            ...
            String input = iu.next();
        if(input.equalsIgnoreCase("d")){
            int nomorFilm = iu.nextInt() - 1;
            detailFilm(nomorFilm,movieFavourite);
            System.out.println("Y/N untuk melanjutkan daftar Film");
            cek = iu.next();
        }
        else if(input.equalsIgnoreCase("a")){
            addFilm(movieFavourite,iu);
            daftarFilm(movieFavourite);
            System.out.println("Y/N untuk melanjutkan daftar Film");
            cek = iu.next();
        }
        else if(input.equalsIgnoreCase("r")){
            int deleteNumberOfFilm = iu.nextInt() - 1;
    ...
    public static void addFilm(HashMap<String, ArrayList<String>> movieFavourite, Scanner Jieun){
        Jieun.nextLine();
        String judul;   String rilis;   String durasi;
        String genre;   String sinopsis;    String cast;

        System.out.println("Judul:"); judul = Jieun.nextLine();
        System.out.println("Rilis:"); rilis = Jieun.nextLine(); 
        System.out.println("Durasi:"); durasi = Jieun.nextLine();
        System.out.println("Genre:"); genre = Jieun.nextLine();
        System.out.println("Sinopsis:"); sinopsis = Jieun.nextLine();
        System.out.println("Cast:"); cast = Jieun.nextLine();
