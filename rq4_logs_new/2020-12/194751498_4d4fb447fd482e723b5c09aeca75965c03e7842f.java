...
import com.microsoft.azure.management.containerservice.v2020_12_01.implementation.AgentPoolInner;
...
public interface AgentPool extends HasInner<AgentPoolInner>, Indexable, Refreshable<AgentPool>, Updatable<AgentPool.Update>, HasManager<ContainerServiceManager> {
    ...
    interface DefinitionStages {
        ...
        interface WithEnableEncryptionAtHost {
            /**
             * Specifies enableEncryptionAtHost.
        ...
        interface WithKubeletDiskType {
            /**
             * Specifies kubeletDiskType.
             * @param kubeletDiskType KubeletDiskType determines the placement of emptyDir volumes, container runtime data root, and Kubelet ephemeral storage. Currently allows one value, OS, resulting in Kubelet using the OS disk for data. Possible values include: 'OS'
             * @return the next definition stage
             */
