...
export const Shareds: any[] = [RuI18n, AccountStorage, LangStorage, LanguagesItem, TokenInterceptor, TokenStorage, TransferHttpCacheInterceptor, ContentType, Group, Permission, User, transformStringToObject, transformStringToDate, transformDateToString, serializeModel, NotEqualsToPassword, ErrorsExtractor, translate];
