...
{
    public class ToolUpdateAllLocalCommandTests
    {
        ...
        private readonly ToolUpdateAllCommand _defaultToolUpdateLocalCommand;
        ...
        public ToolUpdateAllLocalCommandTests()
        {
            ...
            _parseResult = Parser.Instance.Parse($"dotnet tool update --all --local");
            ...
            _manifestInspector = new ToolManifestFinder(
                new DirectoryPath(_temporaryDirectory),
                _fileSystem);

            _defaultToolUpdateLocalCommand = new ToolUpdateAllCommand(
                Parser.Instance.Parse($"dotnet tool update --all --local"),
                reporter: _reporter,
                toolPackageDownloader: _toolPackageDownloaderMock,
                ...
                manifestInspector: _manifestInspector
                );
        }
        ...
        [Fact]
        public void GivenNoManifestFileItShouldNotUpdate()
        {
