...
from lhotse.recipes.tedlium2 import TEDLIUM_PARTS, download_tedlium2, prepare_tedlium2
...
@click.option(
    ...
    help=f"Which parts of TED-LIUM v2 to prepare (by default all, i.e., {TEDLIUM_PARTS}).",
)
@click.option(
    "-j",
    "--num-jobs",
