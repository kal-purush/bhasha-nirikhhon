...
describeDevMoonbeam(
  "Mock XCM V3 - downward transfer with non-triggered error handler",
  (context) => {
    let assetId: string;
...
describeDevMoonbeam("Mock XCM V3 - downward transfer with triggered error handler", (context) => {
  let assetId: string;
...
describeDevMoonbeam("Mock XCM V3 - downward transfer with always triggered appendix", (context) => {
  let assetId: string;
...
describeDevMoonbeam("Mock XCM V3 - downward transfer claim trapped assets", (context) => {
  let assetId: string;
