...
namespace JobSeek.Api.Migrations
{
    ...
    [Migration("20230509160946_Changeing-table-job-and-related-entities")]
    partial class Changeingtablejobandrelatedentities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobSeek.Api.Models.Entities.Employer", b =>
                {
                    ...
                    b.Property<string>("CompanyLicenseNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("NumberOfCompanyMembers")
                        .HasColumnType("int");
