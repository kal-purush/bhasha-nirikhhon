...
export const whitePrimary = 'var(--plasma-colors-white-primary, #f5f5f5F5)';

/** @deprecated instead use onDarkTextSecondary */
export const whiteSecondary = 'var(--plasma-colors-white-secondary, #F5f5f58F)';

/** @deprecated instead use onDarkTextTertiary */
export const whiteTertiary = 'var(--plasma-colors-white-tertiary, #F5f5f548)';

/** @deprecated instead use onLightTextPrimary */
export const blackPrimary = 'var(--plasma-colors-black-primary, #171717F5)';

/** @deprecated instead use onLightTextSecondary */
export const blackSecondary = 'var(--plasma-colors-black-secondary, #1717178F)';

/** @deprecated instead use onLightTextTertiary */
export const blackTertiary = 'var(--plasma-colors-black-tertiary, #17171748)';
...
export const text = 'var(--plasma-colors-text, #f5f5f5F5)';

/** @deprecated instead use textPrimary */
export const primary = 'var(--plasma-colors-primary, #f5f5f5F5)';

/** @deprecated instead use textSecondary */
export const secondary = 'var(--plasma-colors-secondary, #F5f5f58F)';

/** @deprecated instead use textTertiary */
export const tertiary = 'var(--plasma-colors-tertiary, #F5f5f548)';

/** @deprecated instead use textParagraph */
export const paragraph = 'var(--plasma-colors-paragraph, #f5f5f5cc)';

/** @deprecated instead use backgroundPrimary */
export const background = 'var(--plasma-colors-background, #080808FF)';

/** @deprecated instead use textAccent */
export const accent = 'var(--plasma-colors-accent, #24B23EFF)';
...
export const critical = 'var(--plasma-colors-critical, #FF3D51FF)';

/** @deprecated instead use overlaySoft */
export const overlay = 'var(--plasma-colors-overlay, #0808088F)';

/** @deprecated instead use surfaceTransparentPrimary */
export const surfaceLiquid01 = 'var(--plasma-colors-surface-liquid01, #FFFFFF0F)';
...
export const surfaceCard = 'var(--plasma-colors-surface-card, #FFFFFF0F)';

/** @deprecated instead use surfaceTransparentSecondary */
export const buttonSecondary = 'var(--plasma-colors-button-secondary, rgba(255, 255, 255, 0.12))';

/** @deprecated instead use textAccent */
export const buttonAccent = 'var(--plasma-colors-button-accent, #24B23EFF)';
