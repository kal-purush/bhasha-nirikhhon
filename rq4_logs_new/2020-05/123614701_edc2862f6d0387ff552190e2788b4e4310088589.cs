...
namespace ECS
{
    ...
    class EnginesRootTests
    {
        ...
        {
            var engines = new DisposableEngineBase[] { new DisposableEngine1(), new DisposableEngine2(), new DisposableEngine3() };
        ...
        [TestCase(Description = "Test that engines are disposed when the EngineRoot is disposed, using engines of the same type")]
        public void TestDisposeEngineMultiples()
        {
            var engines = new DisposableEngineMultiple[] { new DisposableEngineMultiple(), new DisposableEngineMultiple(), new DisposableEngineMultiple() };
