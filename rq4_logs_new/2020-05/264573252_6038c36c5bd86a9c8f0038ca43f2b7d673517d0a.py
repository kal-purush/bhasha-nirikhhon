...
class Window(QMainWindow): 
	...
	def UiComponents(self): 
		...
		self.label_total.setStyleSheet("color:white;background-color:blue;") 
		...
		# adding border 
		self.label_reco.setStyleSheet("color:black;background-color:yellow;") 
		...
		# adding border to the label 
		self.label_death.setStyleSheet("color:white;background-color:red;") 
