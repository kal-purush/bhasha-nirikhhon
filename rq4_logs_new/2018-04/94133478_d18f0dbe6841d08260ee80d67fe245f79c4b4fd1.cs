...
namespace SharePoint.Modernization.Framework.Tests.Transform
{
    ...
    public class Text
    {
        ...
        public void TextTest()
        {
            ...
            System.IO.File.WriteAllText(@"C:\github\BertPnPTools\Solutions\SharePoint.Modernization\SharePoint.Modernization.Framework.Tests\Transform\rewrittenhtml.html", transformator.Transform(source));
        }
