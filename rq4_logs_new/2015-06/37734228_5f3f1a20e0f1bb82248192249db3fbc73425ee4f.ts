...
class WaveFile extends AudioFile {
    sampleRate: number;
    byteRate: number;
}
...
function amplify<T extends AudioFile>(file: T, gain: number): T {
    //Ideally, we wouldn't mutate
