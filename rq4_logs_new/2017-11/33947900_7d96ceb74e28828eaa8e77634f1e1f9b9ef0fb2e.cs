...
/**
 * \brief
 *   Google Cloud Vision API Version v1p1beta1
 *
...
namespace Google.Apis.Vision.v1p1beta1
{
    ...
    public class ImagesResource
    {
        ...
        public virtual AnnotateRequest Annotate(Google.Apis.Vision.v1p1beta1.Data.GoogleCloudVisionV1p1beta1BatchAnnotateImagesRequest body)
        {
        ...
        public class AnnotateRequest : VisionBaseServiceRequest<Google.Apis.Vision.v1p1beta1.Data.GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse>
        {
            ...
            {
                get { return "v1p1beta1/images:annotate"; }
            }
...
{    
    ...
    public class GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudVisionV1p1beta1CropHintsParams : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudVisionV1p1beta1ImageContext : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Parameters for crop hints annotation request.</summary>
    ...
    public class GoogleCloudVisionV1p1beta1LatLongRect : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class GoogleCloudVisionV1p1beta1WebDetectionParams : Google.Apis.Requests.IDirectResponseSchema
    {
