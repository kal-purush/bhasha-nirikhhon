...
import static com.applications.philipp.apkinson.R.string.file;

/**
 * Created by TOMAS on 21/04/2017.
 */

public class AccelerometerData extends Thread implements SensorEventListener {
    private Sensor mAcc;
    ...
    public AccelerometerData(SensorManager mSensorManager) {
    ...
    public void startAcc(String pathData) {
        ...
        f = new File(pathData, "Apkinson" + format + ".txt");
        try {
