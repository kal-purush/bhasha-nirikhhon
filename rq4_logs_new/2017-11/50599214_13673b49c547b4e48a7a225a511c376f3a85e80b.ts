...
tmr.setInput('fastlaneArguments', '--app-version 2.1.5');
...
let myAnswers: string = `{
    ...
    "exec": {
        "fastlane deliver submit_build -u creds-username -a com.microsoft.test.appId --skip_binary_upload true --skip_metadata true --skip_screenshots true --automatic_release --force --app-version 2.1.5": {
            "code": 0,
