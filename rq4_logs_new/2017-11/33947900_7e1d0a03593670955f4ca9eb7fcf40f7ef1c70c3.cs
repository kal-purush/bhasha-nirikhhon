...
/**
 * \brief
 *   Service Consumer Management API Version v1
 *
...
namespace Google.Apis.ServiceConsumerManagement.v1
{
    ...
    public class OperationsResource
    {
        ...
        public class CancelRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1.Data.Empty>
        {
            ...
            public CancelRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceConsumerManagement.v1.Data.CancelOperationRequest body, string name)
                : base(service)
            {
                Name = name;
                Body = body;
    ...
    public class ServicesResource
    {
        ...
        private readonly TenancyUnitsResource tenancyUnits;

        /// <summary>Gets the TenancyUnits resource.</summary>
        public virtual TenancyUnitsResource TenancyUnits
        {
            get { return tenancyUnits; }
        }
        ...
        public class TenancyUnitsResource
        {
            ...
            /// <summary>Add a new tenant project to the tenancy unit. If there are previously failed AddTenantProject
            /// calls, you might need to call RemoveTenantProject first to clean them before you can make another
            /// AddTenantProject with the same tag. Operation.</summary>
            /// <param name="body">The body of the request.</param>
            ...
            public class AddProjectRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1.Data.Operation>
            {
                ...
                public AddProjectRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceConsumerManagement.v1.Data.AddTenantProjectRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                public override string RestPath
                {
                    get { return "v1/{+parent}:addProject"; }
                }
            ...
            /// <summary>Creates a tenancy unit with no tenant resources.</summary>
            /// <param name="body">The body of the request.</param>
            ...
            /// consumer numeric id, such as project number: '123456'. {service} the name of a service, for example
            /// 'service.googleapis.com'. Enabled service binding using the new tenancy unit.</param>
            ...
            public class CreateRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1.Data.TenancyUnit>
            {
                ...
                public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceConsumerManagement.v1.Data.CreateTenancyUnitRequest body, string parent)
                    : base(service)
                {
                    Parent = parent;
                    Body = body;
                ...
                /// service, for example 'service.googleapis.com'. Enabled service binding using the new tenancy
                /// unit.</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
                ...
                public override string RestPath
                {
                    get { return "v1/{+parent}/tenancyUnits"; }
                }
            ...
            /// <summary>Delete tenancy unit.  Before the tenancy unit is deleted, there should be no tenant resource in
            ...
            /// <summary>Find tenancy unit for a service and consumer. This method should not be used in producers'
            /// runtime path, e.g. finding the tenant project number when creating VMs. Producers should persist the
            /// tenant project information after the project is created.</summary>
            /// <param name="parent">Service and consumer. Required. services/{service}/{collection id}/{resource id} {collection
            /// id} is the cloud resource collection type representing the service consumer, for example 'projects', or
            /// 'organizations'. {resource id} is the consumer numeric id, such as project number: '123456'. {service} the name of a
            ...
            public class ListRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1.Data.ListTenancyUnitsResponse>
            {
                ...
                /// <summary>Service and consumer. Required. services/{service}/{collection id}/{resource id}
                /// {collection id} is the cloud resource collection type representing the service consumer, for example
                /// 'projects', or 'organizations'. {resource id} is the consumer numeric id, such as project number:
                /// '123456'. {service} the name of a service, for example 'service.googleapis.com'.</summary>
                [Google.Apis.Util.RequestParameterAttribute("parent", Google.Apis.Util.RequestParameterType.Path)]
                public virtual string Parent { get; private set; }
            ...
            /// operation fails, this method fails. Operation.</summary>
            /// <param name="body">The body of the request.</param>
            ...
            public class RemoveProjectRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1.Data.Operation>
            {
                ...
                public RemoveProjectRequest(Google.Apis.Services.IClientService service, Google.Apis.ServiceConsumerManagement.v1.Data.RemoveTenantProjectRequest body, string name)
                    : base(service)
                {
                    Name = name;
                    Body = body;
                ...
                public override string RestPath
                {
                    get { return "v1/{+name}:removeProject"; }
                }
        ...
        /// <summary>Search tenancy units for a service.</summary>
        ...
        public class SearchRequest : ServiceConsumerManagementBaseServiceRequest<Google.Apis.ServiceConsumerManagement.v1.Data.SearchTenancyUnitsResponse>
        {
            ...
            /// to 1000. If page_size is not provided or provided a number larger than 1000, it will be automatically
            /// set to 1000.
            ///
            /// Optional.</summary>
            [Google.Apis.Util.RequestParameterAttribute("pageSize", Google.Apis.Util.RequestParameterType.Query)]
...
{    
    ...
    /// <summary>Request to add a newly created and configured tenant project to tenancy unit.</summary>
    public class AddTenantProjectRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Configuration of the new tenant project that will be added to tenancy unit resources.</summary>
    ...
    /// <summary>Describes billing configuration for new a Tenant Project</summary>
    ...
    /// <summary>Request to create a tenancy unit for a consumer of a service.</summary>
    public class CreateTenancyUnitRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Optional producer provided identifier of the tenancy unit Must be no longer than 40 characters and
        /// preferably URI friendly If it is not provided, UID for the tenancy unit will be auto generated It must be
        /// unique across a service. If the tenancy unit already exists for the service and consumer pair,
        /// CreateTenancyUnit will return existing tenancy unit if provided identifier is identical or empty, otherwise
        /// the call will fail.</summary>
    ...
    {
        /// <summary>Uses the same format as in IAM policy. `member` must include both prefix and id. E.g.,
        /// `user:{emailId}`, `serviceAccount:{emailId}`, `group:{emailId}`.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("members")]
        public virtual System.Collections.Generic.IList<string> Members { get; set; } 

        /// <summary>Role. (https://cloud.google.com/iam/docs/understanding-roles) For example, `roles/viewer`,
        /// `roles/editor`, or `roles/owner`.</summary>
    ...
    /// <summary>Request message to remove tenant project resource from the tenancy unit.</summary>
    ...
    /// <summary>Describes service account configuration for the tenant project.</summary>
    public class ServiceAccountConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Roles for the service account above on tenant project.</summary>
    ...
    {
        /// <summary>@OutputOnly Cloud resource One Platform Name of the consumer of this service. For example
        ...
        /// <summary>Globally unique identifier of this tenancy unit "services/{service}/{collection id}/{resource
        /// id}/tenancyUnits/{unit}"</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 

        /// <summary>@OutputOnly Google Cloud API name of the service owning this tenancy unit. For example
        /// 'serviceconsumermanagement.googleapis.com'.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("service")]
        public virtual string Service { get; set; } 

        /// <summary>Resources constituting the tenancy unit.</summary>
    ...
    /// <summary>This structure defines a tenant project to be added to the specified tenancy unit and its initial
    /// configuration and properties. A project lien will be created for the tenant project to prevent the tenant
    /// project from being deleted accidentally. The lien will be deleted as part of tenant project removal.</summary>
    public class TenantProjectConfig : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Billing account properties. It may be specified explicitly, or created from the specified group
        /// during provisioning</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("billingConfig")]
        public virtual BillingConfig BillingConfig { get; set; } 

        /// <summary>Folder where project in this tenancy unit must be located This folder must have been previously
        /// created with proper permissions for the caller to create and configure a project in it. Valid folder
        /// resource names have the format `folders/{folder_number}` (for example, `folders/123456`).</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("folder")]
        public virtual string Folder { get; set; } 

        /// <summary>Labels that will be applied to this project.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("labels")]
        public virtual System.Collections.Generic.IDictionary<string,string> Labels { get; set; } 

        /// <summary>Configuration for IAM service account on tenant project.</summary>
        ...
        /// any of these services can not be activated, addTenantProject method will fail. For example:
        ...
        /// <summary>Describes ownership and policies for the new tenant project. Required.</summary>
