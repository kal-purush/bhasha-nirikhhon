...
import ttc2018.Solution;

public class LiveContestDriver {
  public enum BenchmarkPhase implements java.lang.Enum {
    Initialization,
    ...
    Update;
    public static LiveContestDriver.BenchmarkPhase valueOf(final java.lang.String name);
  }
  ...
  private static /* String */Object ChangePath;
  
  private static /* String */Object RunIndex;
  
  private static int Sequences;
  
  private static /* String */Object Tool;
  
  private static /* String */Object ChangeSet;
  
  private static /* String */Object Query;
  
  private static long stopwatch;
  
  private static Solution solution;
  
  private static /* Object */Object loadFile(final /* String */Object path) {
    throw new Error("Unresolved compilation problems:"
  ...
  private static /* Object */Object loadDeltaFile(final /* String */Object path) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe field LiveContestDriver.ChangePath refers to the missing type String"
      + "\nThe field Solution.xform refers to the missing type YAMTLModule"
  ...
  public static void Update(final int iteration) {
    throw new Error("Unresolved compilation problems:"
  ...
  public static void Report(final LiveContestDriver.BenchmarkPhase phase, final int iteration, final /* String */Object result) {
    throw new Error("Unresolved compilation problems:"
      + "\nString cannot be resolved to a type."
      + "\n== cannot be resolved."
      + "\n- cannot be resolved."
