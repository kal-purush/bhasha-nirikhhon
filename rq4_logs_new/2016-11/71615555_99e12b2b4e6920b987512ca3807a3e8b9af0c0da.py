# -*- coding: utf-8 -*-
#
# Unicampi documentation build configuration file, created by
# sphinx-quickstart on Mon Nov 5 17:56:04 2016.
#
...
project = u'Unicampi'
copyright = u'2016 — Unicampi Team'
...
htmlhelp_basename = 'Unicampi_doc'
...
latex_documents = [
    ('index', 'Unicampi.tex', u'UnicampiDocumentation',
     u'Unicampi Team', 'manual'),
]
...
man_pages = [
    ('index', 'unicampi', u'Unicampi Documentation',
     [u'Unicampi Team'], 1)
]
...
texinfo_documents = [
    ('index', 'Unicampi', u'Unicampi Documentation',
     u'Unicampi Team', 'Unicampi',
     'An API to fetch most of Unicamp public data',
     'Miscellaneous'),
]