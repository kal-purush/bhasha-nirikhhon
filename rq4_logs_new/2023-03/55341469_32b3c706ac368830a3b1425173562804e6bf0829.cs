...
/// <summary>
/// Tests for <see cref="SqliteStorage"/>.
/// </summary>
public class SqliteStorageTests
{
	...
	public void TryAppend()
	{
		...
		string storagePath = $"{nameof(UnitTests)}.{nameof(SqliteStorage)}.{nameof(TryAppend)}.sqlite";
		File.Delete(storagePath);

		using SqliteStorage indexStorage = SqliteStorage.FromFile(path: storagePath, startingFilter: startingFilter);
	...
	public void TryRemoveLast()
	{
		...
		string storagePath = $"{nameof(UnitTests)}.{nameof(SqliteStorage)}.{nameof(TryRemoveLast)}.sqlite";
		File.Delete(storagePath);
	...
	public void AppendAndRemove()
	{
		...
		string storagePath = $"{nameof(UnitTests)}.{nameof(SqliteStorage)}.{nameof(AppendAndRemove)}.sqlite";
		File.Delete(storagePath);

		using SqliteStorage indexStorage = SqliteStorage.FromFile(path: storagePath, startingFilter: filter0);
	...
	public void TryRemoveLastIfNewerThan()
	{
		...
		string storagePath = $"{nameof(UnitTests)}.{nameof(SqliteStorage)}.{nameof(TryRemoveLastIfNewerThan)}.sqlite";
		File.Delete(storagePath);
	...
	public void Clear()
	{
		...
		string storagePath = $"{nameof(UnitTests)}.{nameof(SqliteStorage)}.{nameof(Clear)}.sqlite";
		File.Delete(storagePath);
		...
		using (SqliteStorage indexStorage2 = SqliteStorage.FromFile(path: storagePath, startingFilter: null))
		{
