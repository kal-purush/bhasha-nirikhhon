...
namespace NowEvent.Data.Migrations
{
    ...
    [Migration("20230326214758_addRequestTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NowEvent.Models.Budget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NowEvent.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NowEvent.Models.EventAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NowEvent.Models.Guest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NowEvent.Models.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NowEvent.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NowEvent.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NowEvent.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NowEvent.Models.Budget", b =>
                {
                    b.HasOne("NowEvent.Models.Event", "Event")
                        .WithMany("Budgets")
            ...
            modelBuilder.Entity("NowEvent.Models.EventAddress", b =>
                {
                    b.HasOne("NowEvent.Models.Event", null)
