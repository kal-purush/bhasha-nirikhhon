...
{
    public class GarmentShippingInsuranceDispositionControllerTest
    {
        ...
        protected virtual GarmentShippingInsuranceDispositionViewModel ViewModel
        {
            get
            {
        ...
        public async Task Put_Ok()
        {
            ...
            serviceMock
                .Setup(s => s.Update(It.IsAny<int>(), It.IsAny<GarmentShippingInsuranceDispositionViewModel>()))
                .ReturnsAsync(1);
        ...
        public async Task Post_Created()
        {
            ...
            var serviceMock = new Mock<IGarmentShippingInsuranceDispositionService>();
            serviceMock
                .Setup(s => s.Create(It.IsAny<GarmentShippingInsuranceDispositionViewModel>()))
                .ReturnsAsync(1);
            var service = serviceMock.Object;
        ...
        public void Get_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new ListResult<GarmentShippingInsuranceDispositionViewModel>(new List<GarmentShippingInsuranceDispositionViewModel>(), 1, 1, 1));
            var service = serviceMock.Object;
        ...
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentShippingInsuranceDispositionViewModel());
            var service = serviceMock.Object;
