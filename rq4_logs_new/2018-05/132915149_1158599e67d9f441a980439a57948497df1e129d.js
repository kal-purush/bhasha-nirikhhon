...
var configjson  = require('./public/ixn/activities/web-push/config.json');
var indexhtml;
fs.readFile('./public/ixn/activities/web-push/index.html', "utf-8", function(err, html) {
...
app.post('/ixn/activities/web-push/save', activity.save );
app.post('/ixn/activities/web-push/validate', activity.validate );
app.post('/ixn/activities/web-push/publish', activity.publish );

//setup middleware for Marketing Cloud API calls:
//app.post('/ixn/activities/web-push/execute/', tokenFromJWT, activity.execute );
app.post('/ixn/activities/web-push/execute', activity.execute );


//replace template values with environment variables.
app.get( '/ixn/activities/web-push/config.json', function( req, res ) {
...
//replace template values with environment variables.
app.get( '/ixn/activities/web-push/index.html', function( req, res ) {
	res.status(200).send( indexhtml );		
});
app.get( '/ixn/activities/web-push/', function( req, res ) {
	res.status(200).send( indexhtml );		
});


// Custom Hello World Trigger Route
app.post('/ixn/triggers/web-push/', trigger.edit );
