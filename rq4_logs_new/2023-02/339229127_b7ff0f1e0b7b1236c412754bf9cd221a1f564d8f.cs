...
{
    public static class LiveMetricsTestConstants
    {
        public const string CounterName = "test-counter";
        public const string GaugeName = "test-gauge";
        public const string HistogramName1 = "test-histogram";
