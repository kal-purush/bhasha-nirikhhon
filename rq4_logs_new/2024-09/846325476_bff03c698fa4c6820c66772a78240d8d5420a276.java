 ...
 */
public class ArpitJena extends Student implements SpecialInterestOrHobby
{
     ...
     * 
     */
    public ArpitJena(String f, String l, int r, int s) {
        firstName=f;
        lastName=l;
        mySeatX=r;
        mySeatY=s;
    ...
    public void act() 
    {
        ...
        if(Greenfoot.mouseClicked(this)){
          //  if (sitting){
                sitting=false;
                setImage("arpitstanding.png");
                System.out.println(""); // Print a blank line to create space between any student output.
                getName();
                sayName("arpitnoise.mp3");
