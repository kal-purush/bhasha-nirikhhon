...
class RegisterReservationAdapterTest {
    @Mock
    ...
    void ShouldRegisterReservation() {
        ...
        // Act
        when(reservationRepository.save(any(ReservationModel.class))).thenReturn(reservationModel(reservation));
        registerReservationAdapter.registerReservation(reservation);
    ...
    private ReservationModel reservationModel(Reservation reservation) {
