...
import { getMarkets, getSpkWallet, rewardSpk } from "@/api/spk-api";
import { getEstimatedBalance } from "@/app/(dynamicPages)/profile/[username]/_components/wallet-spk/util";
