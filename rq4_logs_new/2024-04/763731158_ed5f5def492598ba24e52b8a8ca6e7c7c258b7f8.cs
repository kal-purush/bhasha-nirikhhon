...
namespace MatchMateInfrastructure.Migrations
{
    ...
    [Migration("20240405070829_date-send-message-column")]
    partial class datesendmessagecolumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("Bio")
                        ...
                        .HasComment("Short information for the user");
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.BlockedUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("The id of the set, the composite key would have been too large.");
                    ...
                    b.Property<string>("BlockedUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("The id of the blocked user");

                    b.Property<string>("BlockerUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("The id of the user who has blocked the other");
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.Friendship", b =>
                {
                    ...
                    b.Property<bool>("IsActive")
                        .HasColumnType("bit")
                        .HasComment("The status of a friendship request, can be  pending or active");
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.Message", b =>
                {
                    ...
                    b.Property<DateTime>("DateSend")
                        .HasColumnType("datetime2")
                        .HasComment("When the message is sent, used for sorting the chat");
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.Offer", b =>
                {
                    ...
                    b.Property<DateTime>("Time")
                        .HasColumnType("datetime2")
                        .HasComment("The date of the offer");
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.ReportedOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("The unique identifyer of the offer report");
                    ...
                    b.Property<string>("Comment")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("Aditional explanations for the offer report");

                    b.Property<bool>("IsReasonable")
                        .HasColumnType("bit")
                        .HasComment("Shows if admin finds this report a strike towards the suggester resume");

                    b.Property<int>("OfferId")
                        .HasColumnType("int")
                        .HasComment("The id of the reported offer");

                    b.Property<int>("ReasonForRepport")
                        .HasColumnType("int")
                        .HasComment("The reason for submitting the report the report");
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.BlockedUsers", b =>
                {
                    b.HasOne("MatchMateInfrastructure.Models.ApplicationUser", "BlockedUser")
                        .WithMany("BeingBlockedBy")
                        .HasForeignKey("BlockedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MatchMateInfrastructure.Models.ApplicationUser", "BlockerUser")
                        .WithMany("BlockedUsersByMe")
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.ReportedOffer", b =>
                {
                    b.HasOne("MatchMateInfrastructure.Models.Offer", "Offer")
                        .WithOne("ReportedOffer")
                        .HasForeignKey("MatchMateInfrastructure.Models.ReportedOffer", "OfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MatchMateInfrastructure.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MatchMateInfrastructure.Models.ApplicationUser", b =>
                {
                    b.Navigation("BeingBlockedBy");

                    b.Navigation("BlockedUsersByMe");
