...
public class BodyManager : MonoBehaviour
{
	...
	public void Initialize(int year, int month, int day, Action<(string, string, string, string)> clickEventHandler)
	{
		...
		foreach(var a in arr)
		{
			...
			{
				buttonManager.Initialize(a.ToString(), month.ToString(), year.ToString(), clickEventHandler, a==day && month==DateTime.Now.Month);
			}
