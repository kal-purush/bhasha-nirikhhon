...
namespace LagDaemon.YAMUD.API.Migrations
{
    ...
    [Migration("20240424164944_changed-address-to-owned")]
    partial class changedaddresstoowned
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LagDaemon.YAMUD.Model.Map.Room", b =>
                {
                    b.OwnsOne("LagDaemon.YAMUD.Model.Map.RoomAddress", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("LagDaemon.YAMUD.Model.User.PlayerState", b =>
                {
                    ...
                    b.OwnsOne("LagDaemon.YAMUD.Model.Map.RoomAddress", "CurrentLocation", b1 =>
                        {
                            b1.Property<Guid>("PlayerStateId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("PlayerStateId");

                            b1.ToTable("PlayerState");
