...
package com.ach.androidcertf.activities.toast;
...
public class CustomToast {
     ...
     * @hide
     */
    @IntDef(prefix = {"LENGTH_"}, value = { // not sure why this rejected syntax is allowed, but  probably it has to do with the RetentionPolicy type which discards the declaration on compile
            LENGTH_SHORT,
            LENGTH_LONG
    })
    ...
    public void show() {
        ...
        String pkg = mContext.getOpPackageName();  //https://developer.android.com/reference/android/content/Context.html#getOpPackageName()
        TN tn = mTN;
    ...
    public static Toast makeText(@NonNull Context context, @Nullable Looper looper,
        ...
        Toast result = new Toast(context, looper); // Inits a Toast object by passing context and a looper https://stackoverflow.com/a/34522758/8939897
        ...
        public void handleShow(IBinder windowToken) {
            ...
            if (mView != mNextView) {
                ...
                try {
                    ...
                    mWM.addView(mView, mParams);     // to show
