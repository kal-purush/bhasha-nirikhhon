...
import { setRootAcl, setPublicAcl } from '../rdf/setRootAcl'
...
export class AclManager {
  ...
  setRootAcl (storageRoot: URL, owner: URL) {
    return setRootAcl(this.storeManager.storage, owner, storageRoot)
  }
  setPublicAcl (inboxUrl: URL, owner: URL, modeName: string) {
    return setPublicAcl(this.storeManager.storage, owner, inboxUrl, modeName)
  }
}