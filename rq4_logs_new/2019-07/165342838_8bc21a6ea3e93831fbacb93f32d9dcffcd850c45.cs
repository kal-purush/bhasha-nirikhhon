...
{
    public class PvpAmuletsClientTests : BaseEndpointClientTests
    {
        public PvpAmuletsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Pvp.Amulets;
            this.Client = this.client;
        }

        private readonly IPvpAmuletsClient client;
