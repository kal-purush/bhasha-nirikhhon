...
{
    public class ProfessionsClientTests : BaseEndpointClientTests
    {
        public ProfessionsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Professions;
            this.Client = this.client;
        }

        private readonly IProfessionsClient client;
