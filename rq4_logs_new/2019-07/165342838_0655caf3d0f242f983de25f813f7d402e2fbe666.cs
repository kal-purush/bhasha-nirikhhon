...
{
    public class PvpSeasonsClientTests : BaseEndpointClientTests
    {
        public PvpSeasonsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Pvp.Seasons;
            this.Client = this.client;
        }

        private readonly IPvpSeasonsClient client;
