...
{
    public class PvpStatsClientTests : BaseEndpointClientTests
    {
        public PvpStatsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Pvp.Stats;
            this.Client = this.client;
        }

        private readonly IPvpStatsClient client;
