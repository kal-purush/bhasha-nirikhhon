...
{
    public class PetsClientTests : BaseEndpointClientTests
    {
        public PetsClientTests()
        {
            ...
            this.client = new Gw2Client(connection).WebApi.V2.Pets;
            this.Client = this.client;
        }

        private readonly IPetsClient client;
