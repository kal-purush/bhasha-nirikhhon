...
/**
 * \brief
 *   Google Cloud KMS API Version v1beta1
 *
 * \section ApiInfo API Version Information
 *    <table>
 *      <tr><th>API
 *          <td><a href='https://cloud.google.com/kms/'>Google Cloud KMS API</a>
 ...
 *
 * The complete API documentation for using Google Cloud KMS API can be found at
...
namespace Google.Apis.CloudKMS.v1beta1
{
    ...
    public class CloudKMSService : Google.Apis.Services.BaseClientService
    {
        ...
        /// <summary>Available OAuth 2.0 scopes for use with the Google Cloud KMS API.</summary>
        public class Scope
        {
    ...
    public class ProjectsResource
    {
        ...
        public class LocationsResource
        {
            ...
            public class KeyRingsResource
            {
                ...
                public class CryptoKeysResource
                {
                    ...
                    public class CryptoKeyVersionsResource
                    {
                        ...
                        public virtual CreateRequest Create(Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion body, string parent)
                        {
                        ...
                        /// The server will assign the next sequential id. If unset, state will be set to
                        /// ENABLED.</summary>
                        public class CreateRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion>
                        {
                            /// <summary>Constructs a new Create request.</summary>
                            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion body, string parent)
                                : base(service)
                            {
                                Parent = parent;
                                Body = body;
                            ...
                            Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion Body { get; set; }
                            ...
                            {
                                get { return "v1beta1/{+parent}/cryptoKeyVersions"; }
                            }
                        ...
                        public virtual DestroyRequest Destroy(Google.Apis.CloudKMS.v1beta1.Data.DestroyCryptoKeyVersionRequest body, string name)
                        {
                        ...
                        /// Before the destroy_time is reached, RestoreCryptoKeyVersion may be called to reverse the
                        /// process.</summary>
                        public class DestroyRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion>
                        {
                            /// <summary>Constructs a new Destroy request.</summary>
                            public DestroyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.DestroyCryptoKeyVersionRequest body, string name)
                                : base(service)
                            {
                                Name = name;
                                Body = body;
                            ...
                            /// <summary>Gets or sets the body of this request.</summary>
                            Google.Apis.CloudKMS.v1beta1.Data.DestroyCryptoKeyVersionRequest Body { get; set; }
                        ...
                        /// <summary>Returns metadata for a given CryptoKeyVersion.</summary>
                        public class GetRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion>
                        {
                        ...
                        /// <summary>Lists CryptoKeyVersions.</summary>
                        public class ListRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.ListCryptoKeyVersionsResponse>
                        {
                        ...
                        public virtual PatchRequest Patch(Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion body, string name)
                        {
                        ...
                        /// state may be changed between ENABLED and DISABLED using this method. See
                        /// DestroyCryptoKeyVersion and RestoreCryptoKeyVersion to move between other states.</summary>
                        public class PatchRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion>
                        {
                            /// <summary>Constructs a new Patch request.</summary>
                            public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion body, string name)
                                : base(service)
                            {
                                Name = name;
                                Body = body;
                        ...
                        public virtual RestoreRequest Restore(Google.Apis.CloudKMS.v1beta1.Data.RestoreCryptoKeyVersionRequest body, string name)
                        {
                        ...
                        /// Upon restoration of the CryptoKeyVersion, state will be set to DISABLED, and destroy_time
                        /// will be cleared.</summary>
                        public class RestoreRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKeyVersion>
                        {
                            /// <summary>Constructs a new Restore request.</summary>
                            public RestoreRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.RestoreCryptoKeyVersionRequest body, string name)
                                : base(service)
                            {
                                Name = name;
                                Body = body;
                            ...
                            /// <summary>Gets or sets the body of this request.</summary>
                            Google.Apis.CloudKMS.v1beta1.Data.RestoreCryptoKeyVersionRequest Body { get; set; }
                            ...
                            public override string RestPath
                            {
                                get { return "v1beta1/{+name}:restore"; }
                            }
                    ...
                    public virtual CreateRequest Create(Google.Apis.CloudKMS.v1beta1.Data.CryptoKey body, string parent)
                    {
                        return new CreateRequest(service, body, parent);
                    }
                    ...
                    ///
                    /// CryptoKey.purpose is required.</summary>
                    public class CreateRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKey>
                    {
                        /// <summary>Constructs a new Create request.</summary>
                        public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.CryptoKey body, string parent)
                            : base(service)
                        {
                            Parent = parent;
                            Body = body;
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudKMS.v1beta1.Data.CryptoKey Body { get; set; }
                        ...
                        public override string RestPath
                        {
                            get { return "v1beta1/{+parent}/cryptoKeys"; }
                        }
                    ...
                    public virtual DecryptRequest Decrypt(Google.Apis.CloudKMS.v1beta1.Data.DecryptRequest body, string name)
                    {
                        return new DecryptRequest(service, body, name);
                    }

                    /// <summary>Decrypt data that was protected by Encrypt.</summary>
                    public class DecryptRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.DecryptResponse>
                    {
                        /// <summary>Constructs a new Decrypt request.</summary>
                        public DecryptRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.DecryptRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudKMS.v1beta1.Data.DecryptRequest Body { get; set; }
                        ...
                        public override string RestPath
                        {
                            get { return "v1beta1/{+name}:decrypt"; }
                        }
                    ...
                    public virtual EncryptRequest Encrypt(Google.Apis.CloudKMS.v1beta1.Data.EncryptRequest body, string name)
                    {
                        return new EncryptRequest(service, body, name);
                    }

                    /// <summary>Encrypt data, so that it can only be recovered by a call to Decrypt.</summary>
                    public class EncryptRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.EncryptResponse>
                    {
                        /// <summary>Constructs a new Encrypt request.</summary>
                        public EncryptRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.EncryptRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudKMS.v1beta1.Data.EncryptRequest Body { get; set; }
                        ...
                        public override string RestPath
                        {
                            get { return "v1beta1/{+name}:encrypt"; }
                        }
                    ...
                    /// <summary>Returns metadata for a given CryptoKey, as well as its primary
                    /// CryptoKeyVersion.</summary>
                    public class GetRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKey>
                    {
                        /// <summary>Constructs a new Get request.</summary>
                        public GetRequest(Google.Apis.Services.IClientService service, string name)
                            : base(service)
                    ...
                    /// <summary>Gets the access control policy for a resource. Returns an empty policy if the resource
                    /// exists and does not have a policy set.</summary>
                    public class GetIamPolicyRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.Policy>
                    {
                    ...
                    /// <summary>Lists CryptoKeys.</summary>
                    public class ListRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.ListCryptoKeysResponse>
                    {
                        /// <summary>Constructs a new List request.</summary>
                        public ListRequest(Google.Apis.Services.IClientService service, string parent)
                            : base(service)
                    ...
                    /// `projects/locations/keyRings/cryptoKeys`.</param>
                    public virtual PatchRequest Patch(Google.Apis.CloudKMS.v1beta1.Data.CryptoKey body, string name)
                    {
                        return new PatchRequest(service, body, name);
                    }

                    /// <summary>Update a CryptoKey.</summary>
                    public class PatchRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKey>
                    {
                        /// <summary>Constructs a new Patch request.</summary>
                        public PatchRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.CryptoKey body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                    ...
                    /// <summary>Sets the access control policy on the specified resource. Replaces any existing
                    /// policy.</summary>
                    public class SetIamPolicyRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.Policy>
                    {
                        /// <summary>Constructs a new SetIamPolicy request.</summary>
                        public SetIamPolicyRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.SetIamPolicyRequest body, string resource)
                            : base(service)
                        {
                            Resource = resource;
                            Body = body;
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudKMS.v1beta1.Data.SetIamPolicyRequest Body { get; set; }
                    ...
                    public class TestIamPermissionsRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.TestIamPermissionsResponse>
                    {
                        ...
                        public TestIamPermissionsRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.TestIamPermissionsRequest body, string resource)
                            : base(service)
                        {
                            Resource = resource;
                            Body = body;
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudKMS.v1beta1.Data.TestIamPermissionsRequest Body { get; set; }
                    ...
                    public virtual UpdatePrimaryVersionRequest UpdatePrimaryVersion(Google.Apis.CloudKMS.v1beta1.Data.UpdateCryptoKeyPrimaryVersionRequest body, string name)
                    {
                        return new UpdatePrimaryVersionRequest(service, body, name);
                    }

                    /// <summary>Update the version of a CryptoKey that will be used in Encrypt</summary>
                    public class UpdatePrimaryVersionRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.CryptoKey>
                    {
                        /// <summary>Constructs a new UpdatePrimaryVersion request.</summary>
                        public UpdatePrimaryVersionRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.UpdateCryptoKeyPrimaryVersionRequest body, string name)
                            : base(service)
                        {
                            Name = name;
                            Body = body;
                        ...
                        /// <summary>Gets or sets the body of this request.</summary>
                        Google.Apis.CloudKMS.v1beta1.Data.UpdateCryptoKeyPrimaryVersionRequest Body { get; set; }
                        ...
                        public override string RestPath
                        {
                            get { return "v1beta1/{+name}:updatePrimaryVersion"; }
                        }
                ...
                public virtual CreateRequest Create(Google.Apis.CloudKMS.v1beta1.Data.KeyRing body, string parent)
                {
                    return new CreateRequest(service, body, parent);
                }

                /// <summary>Create a new KeyRing in a given Project and Location.</summary>
                public class CreateRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.KeyRing>
                {
                    /// <summary>Constructs a new Create request.</summary>
                    public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.CloudKMS.v1beta1.Data.KeyRing body, string parent)
                        : base(service)
                    {
                        Parent = parent;
                        Body = body;
                    ...
                    /// <summary>Gets or sets the body of this request.</summary>
                    Google.Apis.CloudKMS.v1beta1.Data.KeyRing Body { get; set; }
                    ...
                    public override string RestPath
                    {
                        get { return "v1beta1/{+parent}/keyRings"; }
                    }
                ...
                /// <summary>Returns metadata for a given KeyRing.</summary>
                public class GetRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.KeyRing>
                {
                    /// <summary>Constructs a new Get request.</summary>
                    public GetRequest(Google.Apis.Services.IClientService service, string name)
                        : base(service)
                ...
                /// <summary>Lists KeyRings.</summary>
                public class ListRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.ListKeyRingsResponse>
                {
                    /// <summary>Constructs a new List request.</summary>
                    public ListRequest(Google.Apis.Services.IClientService service, string parent)
                        : base(service)
            ...
            /// <summary>Get information about a location.</summary>
            public class GetRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.Location>
            {
                /// <summary>Constructs a new Get request.</summary>
                public GetRequest(Google.Apis.Services.IClientService service, string name)
                    : base(service)
            ...
            /// <summary>Lists information about the supported locations for this service.</summary>
            public class ListRequest : CloudKMSBaseServiceRequest<Google.Apis.CloudKMS.v1beta1.Data.ListLocationsResponse>
            {
                /// <summary>Constructs a new List request.</summary>
...
namespace Google.Apis.CloudKMS.v1beta1.Data
{    
