...
namespace ImageProcessingOlamit
{
    internal class ConvFilters
    {
        ...
        public bool Smooth(Bitmap b, int nWeight /* default to 1 */)
        {
            ...
            m.Pixel = nWeight;
            m.Factor = nWeight + 8;
            Debug.WriteLine(nWeight);

            return Conv3x3(b, m);
        }

        public bool GaussianBlur(Bitmap b, int nWeight /* default to 4*/)
        {
            ConvMatrix m = new ConvMatrix();
            m.SetAll(1);
            m.Pixel = nWeight;
        ...
        public bool MeanRemoval(Bitmap b, int nWeight /* default to 9*/ )
        {
            ConvMatrix m = new ConvMatrix();
            m.SetAll(-1);
            m.Pixel = nWeight;
        ...
        public bool Sharpen(Bitmap b, int nWeight /* default to 11*/ )
        {
            ConvMatrix m = new ConvMatrix();
            m.SetAll(0);
            m.Pixel = nWeight;
        ...
        public bool EmbossLaplacian(Bitmap b)
        {
            ConvMatrix m = new ConvMatrix();
            m.SetAll(-1);
        ...
        public bool EdgeDetectQuick(Bitmap b)
        {
            ConvMatrix m = new ConvMatrix();
        ...
        public bool EdgeDetectConvolution(Bitmap b, short nType, byte nThreshold)
        {
            ConvMatrix m = new ConvMatrix();
        ...
        public bool EdgeDetectHorizontal(Bitmap b)
        {
        ...
        public bool EdgeDetectVertical(Bitmap b)
        {
            Bitmap bmTemp = (Bitmap)b.Clone();
        ...
        public bool EdgeDetectDifference(Bitmap b, byte nThreshold)
        {
            // This one works by working out the greatest difference between a pixel and it's eight neighbours.
            // The threshold allows softer edges to be forced down to black, use 0 to negate it's effect.
            Bitmap b2 = (Bitmap)b.Clone();
        ...
        public bool EdgeEnhance(Bitmap b, byte nThreshold)
        {
