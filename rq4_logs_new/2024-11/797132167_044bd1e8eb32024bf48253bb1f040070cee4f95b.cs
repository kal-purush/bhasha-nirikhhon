...
public class ZipHelper
{
    ...
    public static Stream ConvertFileToToStream(IFormFile file)
    {
        var compressedData = ConvertIFormFileToByteArray(file);
        string jsonData = DecompressDeflateData(compressedData);
        return ConvertStringToStream(jsonData);
    }
}