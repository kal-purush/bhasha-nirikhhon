 ...
 * @author DIVIII
 */
public class StocklevelInventory extends javax.swing.JFrame {

    /**
     * Creates new form StocklevelInventory
     */
    public StocklevelInventory() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StocklevelInventory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StocklevelInventory().setVisible(true);
            }
        });
    }
