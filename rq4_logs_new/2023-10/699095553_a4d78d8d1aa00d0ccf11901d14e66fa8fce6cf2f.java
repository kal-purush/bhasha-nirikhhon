...
public class Main
{
	public static void main(String[] args) {
	    ...
	    System.out.println("Enter the name of the student whose information to be removed from the database");
	    String find_name = sc.next();
	    System.out.println("The student information are as follows");
