function runRayOfParameterMidpoints() {
    var rayOfParameterMidpoints = new RayOfParameterMidpoints();
    rayOfParameterMidpoints.run();
}
class RayOfParameterMidpoints {

    public run(): void {
        this.createSphere();
        this.createThreePlanes();
