...
namespace HealthGateway.Database.Migrations
{
    ...
    [Migration("20230824180327_AddCancerScreeningCommentEntryTypeCode")]
    partial class AddCancerScreeningCommentEntryTypeCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthGateway.Common.Data.Models.Email", b =>
                {
                    ...
                    b.Property<Dictionary<string, string>>("Personalization")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("HealthGateway.Common.Data.Models.LegalAgreement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("HealthGateway.Common.Data.Models.MessagingVerification", b =>
                {
                    ...
                    b.Property<string>("SmsValidationCode")
                        ...
                        .HasColumnName("SMSValidationCode");
            ...
            modelBuilder.Entity("HealthGateway.Common.Data.Models.UserProfile", b =>
                {
                    ...
                    b.Property<string>("LastLoginClientCode")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
                    ...
                    b.HasIndex("LastLoginClientCode");
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.AuditGroupCode", b =>
                {
                    ...
                    b.ToTable("AuditGroupCode", "gateway");
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.AuditOperationCode", b =>
                {
                    ...
                    b.ToTable("AuditOperationCode", "gateway");
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.BlockedAccess", b =>
                {
                    ...
                    b.ToTable("BlockedAccess", "gateway");
                });
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.Communication", b =>
                {
                    b.Property<Guid>("Id")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "CommunicationId");
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.PharmaCareDrug", b =>
                {
                    ...
                    b.Property<string>("LcaIndicator")
                        ...
                        .HasColumnName("LCAIndicator");

                    b.Property<decimal?>("LcaPrice")
                        .HasColumnType("decimal(8,4)")
                        .HasColumnName("LCAPrice");
                    ...
                    b.Property<string>("RdpCategory")
                        .HasMaxLength(4)
                        .HasColumnType("character varying(4)")
                        .HasColumnName("RDPCategory");

                    b.Property<string>("RdpExcludedPlans")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("RDPExcludedPlans");

                    b.Property<decimal?>("RdpPrice")
                        .HasColumnType("decimal(8,4)")
                        .HasColumnName("RDPPrice");
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.UserLoginClientTypeCode", b =>
                {
                    ...
                    b.HasKey("UserLoginClientCode");

                    b.ToTable("UserLoginClientTypeCode", "gateway");
            ...
            modelBuilder.Entity("HealthGateway.Common.Data.Models.UserProfile", b =>
                {
                    b.HasOne("HealthGateway.Database.Models.UserLoginClientTypeCode", null)
                        .WithMany()
                        .HasForeignKey("LastLoginClientCode")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("HealthGateway.Common.Data.Models.LegalAgreement", "TermsOfService")
                        .WithMany()
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.AgentAudit", b =>
                {
                    b.HasOne("HealthGateway.Database.Models.AuditGroupCode", null)
                        .WithMany()
                        .HasForeignKey("GroupCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HealthGateway.Database.Models.AuditOperationCode", null)
                        .WithMany()
