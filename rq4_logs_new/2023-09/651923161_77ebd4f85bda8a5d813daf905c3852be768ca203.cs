...
namespace API.Migrations
{
    ...
    [Migration("20230903193128_PhotoApprovalAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.UserInvitation", b =>
                {
            ...
            modelBuilder.Entity("API.Entities.UserInvitation", b =>
                {
                    b.HasOne("API.Entities.User", "SourceUser")
                        .WithMany("InvideUsers")
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.User", "TargetUser")
                        .WithMany("InvidedByUsers")
            ...
            modelBuilder.Entity("API.Entities.User", b =>
                {
                    b.Navigation("InvideUsers");

                    b.Navigation("InvidedByUsers");
