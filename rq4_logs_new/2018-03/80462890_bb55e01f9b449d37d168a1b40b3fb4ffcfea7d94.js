...
/******/ 	var hotCurrentHash = "01438a116eedb7f14c88"; // eslint-disable-line no-unused-vars
...
var sketch = function sketch(p) {
    ...
    p.setup = function () {
        ...
        github = new _constellation.Constellation(githubPoints);
        github.scale = 1 / 2;
        resumeConstellation = new _constellation.Constellation(resumePoints);
    ...
    p.draw = function () {
        ...
        var nameWidth = p.textWidth('Blaise Marchetti');
...
var TextConstellation = function (_Constellation) {
    _inherits(TextConstellation, _Constellation);

    function TextConstellation(text, font) {
        _classCallCheck(this, TextConstellation);

        var points = font.textToPoints(text, 0, 0, 50);
        return _possibleConstructorReturn(this, (TextConstellation.__proto__ || Object.getPrototypeOf(TextConstellation)).call(this, points));
    }
...
exports.TextConstellation = TextConstellation;
