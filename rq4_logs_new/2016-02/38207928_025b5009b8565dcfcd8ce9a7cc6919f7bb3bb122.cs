...
namespace System.Runtime.CompilerServices
{
    ...
    internal static class JitHelpers
    {
        ...
        //////        [SecurityCritical]
        //////        [FriendAccessAllowed]
        //////static public extern T UnsafeCast<T>( Object o ) where T : class
        //////{
        //////    // The body of this function will be replaced by the EE with unsafe code that just returns o!!!
        //////    // See getILIntrinsicImplementation for how this happens.  
        //////    throw new InvalidOperationException( );
        ...
        static internal extern int UnsafeEnumCast<T>( T val ) where T : struct;		// Actually T must be 4 byte (or less) enum
        //////{
        //////    // should be return (int) val; but C# does not allow, runtime does this magically
        //////    // See getILIntrinsicImplementation for how this happens.  
        //////    throw new InvalidOperationException( );
        ...
        [MethodImpl( MethodImplOptions.InternalCall )]
        static internal extern long UnsafeEnumCastLong<T>( T val ) where T : struct;	// Actually T must be 8 byte enum
        //////{
