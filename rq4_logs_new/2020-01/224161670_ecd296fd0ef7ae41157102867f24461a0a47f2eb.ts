...
Les mer på [Datatilsynets nettsider](https://datatilsynet.no)`,
  dataControllerRepresentativeInEUAbstract: `Et personvernombud skal gi råd om hvordan den behandlingsansvarlige best mulig kan ivareta personverninteressene. `,
  dataControllerRepresentativeInEUDescription: `Noen virksomheter har plikt til å ha ombud, mens andre kan ha det dersom de ønsker, se artikkel 37 flg eller les mer på [Datatilsynets nettsider](https://datatilsynet.no)`
};