...
public final class Keywords {
  ...
  public static final String ENDDO_RU = "КонецЦикла";
  public static final String ENDDO_UP_RU = "КОНЕЦЦИКЛА";
  public static final String ENDDO_EN = "EndDo";
  public static final String ENDDO_UP_EN = "ENDDO";
  ...
  public static final String ENDPROCEDURE_RU = "КонецПроцедуры";
  public static final String ENDPROCEDURE_UP_RU = "КОНЕЦПРОЦЕДУРЫ";
  public static final String ENDPROCEDURE_EN = "EndProcedure";
  public static final String ENDPROCEDURE_UP_EN = "ENDPROCEDURE";
  ...
  public static final String ENDFUNCTION_RU = "КонецФункции";
  public static final String ENDFUNCTION_UP_RU = "КОНЕЦФУНКЦИИ";
  public static final String ENDFUNCTION_EN = "EndFunction";
  public static final String ENDFUNCTION_UP_EN = "ENDFUNCTION";
  ...
  public static final String ENDTRY_RU = "КонецПопытки";
  public static final String ENDTRY_UP_RU = "КОНЕЦПОПЫТКИ";
  public static final String ENDTRY_EN = "EndTry";
  public static final String ENDTRY_UP_EN = "ENDTRY";
  ...
  public static final String ADDHANDLER_RU = "ДобавитьОбработчик";
  public static final String ADDHANDLER_UP_RU = "ДОБАВИТЬОБРАБОТЧИК";
  public static final String ADDHANDLER_EN = "AddHandler";
  public static final String ADDHANDLER_UP_EN = "ADDHANDLER";
  public static final String REMOVEHANDLER_RU = "УдалитьОбработчик";
  public static final String REMOVEHANDLER_UP_RU = "УДАЛИТЬОБРАБОТЧИК";
  public static final String REMOVEHANDLER_EN = "RemoveHandler";
  public static final String REMOVEHANDLER_UP_EN = "REMOVEHANDLER";
  ...
  public static final String MOBILEAPPCLIENT_RU = "МобильноеПриложениеКлиент";
  public static final String MOBILEAPPCLIENT_UP_RU = "МОБИЛЬНОЕПРИЛОЖЕНИЕКЛИЕНТ";
  public static final String MOBILEAPPCLIENT_EN = "MobileAppClient";
  public static final String MOBILEAPPCLIENT_UP_EN = "MOBILEAPPCLIENT";
  public static final String MOBILEAPPSERVER_RU = "МобильноеПриложениеСервер";
  public static final String MOBILEAPPSERVER_UP_RU = "МОБИЛЬНОЕПРИЛОЖЕНИЕСЕРВЕР";
  public static final String MOBILEAPPSERVER_EN = "MobileAppServer";
  public static final String MOBILEAPPSERVER_UP_EN = "MOBILEAPPSERVER";
  public static final String MOBILECLIENT_RU = "МобильныйКлиент";
  public static final String MOBILECLIENT_UP_RU = "МОБИЛЬНЫЙКЛИЕНТ";
  public static final String MOBILECLIENT_EN = "MobileClient";
  public static final String MOBILECLIENT_UP_EN = "MOBILECLIENT";
  public static final String THICKCLIENTORDINARYAPPLICATION_RU = "ТолстыйКлиентОбычноеПриложение";
  public static final String THICKCLIENTORDINARYAPPLICATION_UP_RU = "ТОЛСТЫЙКЛИЕНТОБЫЧНОЕПРИЛОЖЕНИЕ";
  public static final String THICKCLIENTORDINARYAPPLICATION_EN = "ThickClientOrdinaryApplication";
  public static final String THICKCLIENTORDINARYAPPLICATION_UP_EN = "THICKCLIENTORDINARYAPPLICATION";
  public static final String THICKCLIENTMANAGEDAPPLICATION_RU = "ТолстыйКлиентУправляемоеПриложение";
  public static final String THICKCLIENTMANAGEDAPPLICATION_UP_RU = "ТОЛСТЫЙКЛИЕНТУПРАВЛЯЕМОЕПРИЛОЖЕНИЕ";
  public static final String THICKCLIENTMANAGEDAPPLICATION_EN = "ThickClientManagedApplication";
  public static final String THICKCLIENTMANAGEDAPPLICATION_UP_EN = "THICKCLIENTMANAGEDAPPLICATION";
  public static final String EXTERNALCONNECTION_RU = "ВнешнееСоединение";
  public static final String EXTERNALCONNECTION_UP_RU = "ВНЕШНЕЕСОЕДИНЕНИЕ";
  public static final String EXTERNALCONNECTION_EN = "ExternalConnection";
  public static final String EXTERNALCONNECTION_UP_EN = "EXTERNALCONNECTION";
  public static final String THINCLIENT_RU = "ТонкийКлиент";
  public static final String THINCLIENT_UP_RU = "ТОНКИЙКЛИЕНТ";
  public static final String THINCLIENT_EN = "ThinClient";
  public static final String THINCLIENT_UP_EN = "THINCLIENT";
  public static final String WEBCLIENT_RU = "ВебКлиент";
  public static final String WEBCLIENT_UP_RU = "ВЕБКЛИЕНТ";
  public static final String WEBCLIENT_EN = "WebClient";
  public static final String WEBCLIENT_UP_EN = "WEBCLIENT";

  public static final String ATCLIENT_RU = "НаКлиенте";
  public static final String ATCLIENT_UP_RU = "НАКЛИЕНТЕ";
  public static final String ATCLIENT_EN = "AtClient";
  public static final String ATCLIENT_UP_EN = "ATCLIENT";
  public static final String ATSERVER_RU = "НаСервере";
  public static final String ATSERVER_UP_RU = "НАСЕРВЕРЕ";
  public static final String ATSERVER_EN = "AtServer";
  public static final String ATSERVER_UP_EN = "ATSERVER";
  public static final String ATSERVERNOCONTEXT_RU = "НаСервереБезКонтекста";
  public static final String ATSERVERNOCONTEXT_UP_RU = "НАСЕРВЕРЕБЕЗКОНТЕКСТА";
  public static final String ATSERVERNOCONTEXT_EN = "AtServerNoContext";
  public static final String ATSERVERNOCONTEXT_UP_EN = "ATSERVERNOCONTEXT";
  public static final String ATCLIENTATSERVERNOCONTEXT_RU = "НаКлиентеНаСервереБезКонтекста";
  public static final String ATCLIENTATSERVERNOCONTEXT_UP_RU = "НАКЛИЕНТЕНАСЕРВЕРЕБЕЗКОНТЕКСТА";
  public static final String ATCLIENTATSERVERNOCONTEXT_EN = "AtClientAtServerNoContext";
  public static final String ATCLIENTATSERVERNOCONTEXT_UP_EN = "ATCLIENTATSERVERNOCONTEXT";
  public static final String ATCLIENTATSERVER_RU = "НаКлиентеНаСервере";
  public static final String ATCLIENTATSERVER_UP_RU = "НАКЛИЕНТЕНАСЕРВЕРЕ";
  public static final String ATCLIENTATSERVER_EN = "AtClientAtServer";
  public static final String ATCLIENTATSERVER_UP_EN = "ATCLIENTATSERVER";
  ...
  public static final String EVENTHANDLERS_REGION_RU = "ОбработчикиСобытий";
  public static final String EVENTHANDLERS_REGION_EN = "EventHandlers";
  public static final String FORMEVENTHANDLERS_REGION_RU = "ОбработчикиСобытийФормы";
  public static final String FORMEVENTHANDLERS_REGION_EN = "FormEventHandlers";
  public static final String FORMHEADERITEMSEVENTHANDLERS_REGION_RU = "ОбработчикиСобытийЭлементовШапкиФормы";
  public static final String FORMHEADERITEMSEVENTHANDLERS_REGION_EN = "FormHeaderItemsEventHandlers";
  public static final String FORMCOMMANDSEVENTHANDLERS_REGION_RU = "ОбработчикиКомандФормы";
  public static final String FORMCOMMANDSEVENTHANDLERS_REGION_EN = "FormCommandsEventHandlers";
