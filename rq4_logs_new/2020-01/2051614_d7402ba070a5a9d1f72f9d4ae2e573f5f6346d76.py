...
class Command(BaseCommand):
    help = "Move all project users (except leaders) out of project safely"
        ...
        def add_arguments(self, parser):
                ...
                parser.add_argument(action='store', dest='Project2', type=str, help='Catchall project for users with no remaining project')
        ...
        def handle(self, *args, **options):
                ...
                for person in members:
                        ...
                        if(person in leaders):
                                ...
                                #determine if the project is the default for any of the user's accounts... but first sort out whether we've got a single case or a list.
