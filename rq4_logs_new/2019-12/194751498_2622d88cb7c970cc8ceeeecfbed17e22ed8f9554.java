 ...
 * even some expected "errors" will be thrown as a {@code DataLakeStorageException}. For example, some users may perform
 * a getProperties request on an entity to determine whether it exists or not. If it does not exists, an exception will
 * be thrown even though this may be considered an expected indication of absence in this case.
 *
...
public final class DataLakeStorageException extends HttpResponseException {
    /**
     * Constructs a {@code DataLakeStorageException}.
     *
