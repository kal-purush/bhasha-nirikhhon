...
describe('LambdaNotificationHandler', () => {
    ...
    it('should pass sns subscription', async done => {
        ...
        expect2(res).toEqual({"body": "NOP", "headers": {"Access-Control-Allow-Credentials": true, "Access-Control-Allow-Origin": "*", "Content-Type": "text/plain; charset=utf-8"}, "statusCode": 200});
