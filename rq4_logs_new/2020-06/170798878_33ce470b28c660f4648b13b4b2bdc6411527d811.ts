export default {
  siteTitle: 'Nirmalya Ghosh', // Navigation and Site Title
  siteTitleAlt: 'Personal portfolio of Nirmalya Ghosh', // Alternative Site title for SEO
  ...
  twitterUrl: '@nirmalyaghosh23', // Twitter Username - Optional
}