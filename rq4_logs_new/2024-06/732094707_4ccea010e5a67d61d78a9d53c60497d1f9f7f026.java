...
public final class ConversationUtils {
    ...
    public static Conversation continueActionWith(ConversationPart conversationPart, Conversation conversation) {
        return () -> concat(Stream.of(conversationPart), conversation.get().stream()).toList();
    }
}