...
const DEFAULT_COERCE_SUCCESS = [
    // numbers -> years is weird (particularly 2-digit!) but included to match plotly.js
    { input: 2015, output: '2015', name: 'from 4-digit number year' },
    { input: 15, output: '15', name: 'from 2-digit number year' },
