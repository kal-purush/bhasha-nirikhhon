...
public class ObjectMetadata implements Serializable {
    ...
    public void setRenamed(int renamed) { this.renamed = renamed; }
    ...
    public int getSubmittedForDeletion() { return submittedForDeletion; }
    public void setSubmittedForDeletion(int submittedForDeletion) { this.submittedForDeletion = submittedForDeletion; }
