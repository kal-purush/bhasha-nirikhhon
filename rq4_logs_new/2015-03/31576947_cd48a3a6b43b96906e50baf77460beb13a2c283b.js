(function () {
   ...
   * # ngPasswordStrength
   */
  angular.module('ngPasswordStrength', ['ngLodash'])
    .directive('ngPasswordStrength', ['lodash', function(_) {
      return {
        template: '<div class="progress"><div class="progress-bar progress-bar-{{class}}" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="100" ng-style="{width : ( value + \'%\' ) }"><span class="sr-only">{{value}}% Complete</span></div></div>',
        restrict: 'A',
        scope: {
