...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions
{
    ...
    /// </summary>
    public sealed class ATLTypeLibraryHarvester
    {
		public ATLTypeLibraryHarvester()
		{
		}

		private void StartProxyProcess64(string file)
		{
			Process proc = new Process();
			proc.StartInfo.FileName = "ATLHarvesterProxy64.exe";
			proc.StartInfo.Arguments = string.Format("tlb \"{0}\"", file);
