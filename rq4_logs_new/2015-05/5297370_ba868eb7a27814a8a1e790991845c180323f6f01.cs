...
namespace SuperSocket.SocketBase
{
    ...
    /// </summary>
    public interface IManagedAppBase : IStatusInfoSource, IServerMetadataProvider, ISystemEndPoint
    {
        /// <summary>
        /// Gets the name.
        /// </summary>
    ...
    /// An item can be started and stopped
    /// </summary>
    public interface IManagedApp : IManagedAppBase, IStatusInfoSource
    {
        /// <summary>
