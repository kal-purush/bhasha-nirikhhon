...
/*
 ...
 MyFonts Webfont Build ID 3027829, 2015-05-18T14:39:40-0400
 ...
 URL: http://www.myfonts.com/fonts/linotype/neue-haas-unica/medium-italic/

 Webfont: NeueHaasUnicaPro-Regular by Linotype
 URL: http://www.myfonts.com/fonts/linotype/neue-haas-unica/regular/


 License: http://www.myfonts.com/viewlicense?type=web&buildid=3027829
...
count.async = !0;
count.src = protocol + "//hello.myfonts.net/count/2e3375";
...
for (var fonts = [{
        ...
        fontWeight: "bold",
        fontStyle: "normal",
        url: wfpath + "2E3375_0" + suffix + "_0." + webfontType
    }, {
        fontFamily: "NeueHaasUnica",
        fontWeight: "bold",
        fontStyle: "italic",
        url: wfpath + "2E3375_1" + suffix + "_0." + webfontType
    }, {
        fontFamily: "NeueHaasUnica",
        fontWeight: "normal",
        fontStyle: "italic",
        url: wfpath + "2E3375_2" + suffix + "_0." + webfontType
    }, {
        fontFamily: "NeueHaasUnica",
        fontWeight: 600,
        fontStyle: "normal",
        url: wfpath + "2E3375_3" + suffix + "_0." + webfontType
    }, {
        fontFamily: "NeueHaasUnicaPro-MediumIt",
        fontWeight: 600,
        fontStyle: "italic",
        url: wfpath + "2E3375_4" +
        ...
        fontWeight: "normal",
        fontStyle: "normal",
        url: wfpath + "2E3375_5" + suffix + "_0." + webfontType
