...
class mainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Arduino controller", pos = wx.DefaultPosition, size = wx.Size( 500,570 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.demandSliderLabel = wx.StaticText( self.controlPanel, wx.ID_ANY, u"X", wx.DefaultPosition, wx.DefaultSize, 0 )
