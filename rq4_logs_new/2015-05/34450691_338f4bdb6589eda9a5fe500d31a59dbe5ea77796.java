...
/**
 * Created by zhangjian on 2015/5/1.
 */
public class Keypad extends Dialog{
    protected final static String TAG = "Sudoku";
    private final View keys[] = new View[9];
    private View keypad;

    private final int useds[];
    private final PuzzleView p;

    public Keypad(Context c,int useds[],PuzzleView p){
        super(c);
        this.useds = useds;
        this.p = p;
    }
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        findViews();
        for(int e:useds){
            if(e!=0) keys[e-1].setVisibility(View.INVISIBLE);
        }
        setListeners();
    }
