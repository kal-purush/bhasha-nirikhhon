 ...
 */
public final class StarRater extends JPanel {
    ...
    /** Listeners. */
    private final List<StarListener> listeners = new ArrayList<StarListener>(1);
     ...
     * @param useRollOver flag to enable roll over (mouse motion)
     */
    public StarRater(int stars, float rating, int selection, final boolean useRollOver) {
        this.stars = stars;
        this.rating = rating;
