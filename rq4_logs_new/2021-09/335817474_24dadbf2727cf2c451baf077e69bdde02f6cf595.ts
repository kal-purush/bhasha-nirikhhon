...
import { GamePick, GamePickFromJSON, GamePickToJSON } from "../models";
...
export class GamePickApi extends runtime.BaseAPI {
  /**
   */
  async gamePickGetGamePickByUserGetRaw(
  ...
  /**
   */
  async gamePickGetGamePickByUserGet(
    requestParameters: GamePickGetGamePickByUserGetRequest
  ...
  /**
   */
  async gamePickGetGamePickGetRaw(
    requestParameters: GamePickGetGamePickGetRequest
  ): Promise<runtime.ApiResponse<GamePick>> {
    const queryParameters: runtime.HTTPQuery = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GamePickFromJSON(jsonValue)
    );
  }

  /**
   */
  async gamePickGetGamePickGet(
    requestParameters: GamePickGetGamePickGetRequest
  ): Promise<GamePick> {
  ...
  /**
   */
  async gamePickGetGamePicksByUserAndWeekGetRaw(
    requestParameters: GamePickGetGamePicksByUserAndWeekGetRequest
  ): Promise<runtime.ApiResponse<Array<GamePick>>> {
    const queryParameters: runtime.HTTPQuery = {};
  ...
  /**
   */
  async gamePickGetGamePicksByUserAndWeekGet(
    requestParameters: GamePickGetGamePicksByUserAndWeekGetRequest
  ): Promise<Array<GamePick>> {
    const response = await this.gamePickGetGamePicksByUserAndWeekGetRaw(
      requestParameters
    );
    return await response.value();
  }
  ...
  /**
   */
  async gamePickUpdateGamePicksPostRaw(
    requestParameters: GamePickUpdateGamePicksPostRequest
  ...
  /**
   */
  async gamePickUpdateGamePicksPost(
    requestParameters: GamePickUpdateGamePicksPostRequest
  ): Promise<boolean> {
    const response = await this.gamePickUpdateGamePicksPostRaw(
      requestParameters
    );
    return await response.value();
  }
