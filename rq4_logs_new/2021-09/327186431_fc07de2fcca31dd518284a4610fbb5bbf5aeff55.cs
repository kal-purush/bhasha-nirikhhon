...
namespace TencentCloud.Af.V20200226.Models
{
    ...
    public class DescribeAntiFraudRequest : AbstractModel
    {
        ...
        public FinanceAntiFraudFilter BusinessSecurityData{ get; set; }

        /// <summary>
        /// 密文业务入参(二选一）
        /// </summary>
        [JsonProperty("BusinessCryptoData")]
        public FinanceAntiFraudCryptoFilter BusinessCryptoData{ get; set; }
