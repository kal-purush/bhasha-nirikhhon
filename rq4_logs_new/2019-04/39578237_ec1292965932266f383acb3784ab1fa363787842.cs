...
namespace OfficeDevPnP.Core.Framework.Provisioning.Model
{
    public class ProvisioningTemplateWebhook: BaseModel, IEquatable<ProvisioningTemplateWebhook>
    {
        ...
        /// <summary>
        /// Compares object with ProvisioningTemplateWebhook class
        /// </summary>
        /// <param name="obj">Object that represents ProvisioningTemplateWebhook</param>
        /// <returns>Checks whether object is ProvisioningTemplateWebhook class</returns>
        public override bool Equals(object obj)
        {
            if (!(obj is ProvisioningTemplateWebhook))
            {
                return (false);
            }
            return (Equals((ProvisioningTemplateWebhook)obj));
        }

        /// <summary>
        /// Compares ProvisioningTemplateWebhook object based on PackagePath and source
        /// </summary>
        /// <param name="other">ProvisioningTemplateWebhook Class object</param>
        /// <returns>true if the ProvisioningTemplateWebhook object is equal to the current object; otherwise, false.</returns>
        public bool Equals(ProvisioningTemplateWebhook other)
        {
            if (other == null)
            {
                return (false);
