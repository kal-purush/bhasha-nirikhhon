...
import Xuehong_Chen from '@/assets/images/kyiv-geneva/participants/Chen-Xuehong.jpg';
import Boyuan_Cheng from '@/assets/images/kyiv-geneva/participants/Cheng-Boyuan.jpeg';
import Jun_Hwi_Cho from '@/assets/images/kyiv-geneva/participants/Cho-Jun Hwi.jpg';
import Roman_Fediurko from '@/assets/images/kyiv-geneva/participants/Fediurko-Roman.jpg';
import Johanna_Goranko from '@/assets/images/kyiv-geneva/participants/Goranko-Joanna.jpg';
import Giuseppe_Guarrera from '@/assets/images/kyiv-geneva/participants/Guarrera-Giuseppe.jpg';
import Kyoshiro_Hirama from '@/assets/images/kyiv-geneva/participants/Hirama-Kyoshiro.jpg';
import Carter_Johnson from '@/assets/images/kyiv-geneva/participants/Johnson-Carter.jpg';
import Shota_Kaya from '@/assets/images/kyiv-geneva/participants/Kaya-Shota.jpeg';
import Stanislav_Korchagin from '@/assets/images/kyiv-geneva/participants/Korchagin-Stanislav.jpg';
import Kisuk_Kwon from '@/assets/images/kyiv-geneva/participants/Kwon-Kisuk.jpg';
import Hyo_Lee from '@/assets/images/kyiv-geneva/participants/Lee-Hyo.jpg';
...
import Danylo_Saienko from '@/assets/images/kyiv-geneva/participants/Saienko-Danylo.jpg';
...
export const participantsData = [
  ...
  {
    img: Elzbieta_Bilicka,
    fullName: {
      ua: 'Ельжбета Біліцька',
      en: 'Elzbieta Bilicka',
    },
  },
  {
  ...
  {
    img: Giuseppe_Guarrera,
    fullName: {
      ua: 'Джузеппе Гуаррера',
      en: 'Giuseppe Guarrera',
    },
  },
  {
    img: Kyoshiro_Hirama,
  ...
  {
    img: Stanislav_Korchagin,
    fullName: {
      ua: 'Станіслав Корчагін',
      en: 'Stanislav Korchagin',
    },
  },
  {
    img: Kisuk_Kwon,
  ...
  {
    img: Roman_Lopatynskyi,
    fullName: {
      ua: 'Роман Лопатинський',
      en: 'Roman Lopatynskyi',
    },
  },
  {
    img: Pedro_Lopez_Salas,
    fullName: {
      ua: 'Педро Лопес Салас',
      en: 'Pedro López Salas',
    },
  },
  {
    img: Danilo_Mascetti,
