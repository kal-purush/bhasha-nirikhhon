...
const routes = {
  '/comments': {
    'POST': createComment //done
  },
  '/comments/:id': {
    'PUT': updateComment, //done
    'DELETE': deleteComment //done
  },
  '/comments/:id/upvote': {
    'PUT': upvoteComment //done
  },
  '/comments/:id/downvote': {
    'PUT': downvoteComment //done
  },
  '/users': {
...
function createComment(url, request) {
  ...
  if(requestComment && requestComment.username && database.users[requestComment.username]
    && requestComment.body && requestComment.articleId && database.articles[requestComment.articleId]){
        const comment = {
...
function updateComment(url, request) {
  ...
  if (!id || !requestComment || requestComment.body === "") {
    ...
    savedComment.url = requestComment.url;
