...
public class FilterToolsTests {
	...
	public void noChildrenTest() {
		...
		assertEquals(1, ft.getCurrentSize());
	}
	...
	public void hasChildrenTest() {
		...
		assertEquals(0, ft.getCurrentSize());
	}
	...
	public void noRelation() {
		...
		assertEquals(1, ft.getRelationSize());
	}
	...
	public void hasRelation() {
		...
		//there should be a problem factsheet since it has no relation
		assertEquals(0, ft.getRelationSize());
	}
	...
	public void noAccountable() {
		...
		assertEquals(1, ft.getAccountableSize());
	}
	...
	public void hasAccountable() {
		...
		//there should not be a problem factsheet since there is an accountable
		assertEquals(0, ft.getAccountableSize());
	}
	...
	public void noResponsible() {
		...
		//there should be a problem factsheet since it has no responsible
		assertEquals(1, ft.getResponsibleSize());
	}
	...
	public void hasResponsible() {
		...
		//there should not be a problem factsheet since there is a responsible
		assertEquals(0, ft.getResponsibleSize());
	}
	...
	public void noBoundedContextOrNoBehavior() {
		...
		//there shouldn't be a problem factsheet since it has one relation
		assertEquals(0, ft2.getRelationSize());
	}
	...
	public void NoBusinessCriticalityOrNoDescription() {
		...
		assertEquals(1, ft.getBusinessCriticalitySize());
		...
		assertEquals(1, ft2.getBusinessCriticalitySize());
	...
	public void hasBusinessCriticalityAndDescription() {
		...
		assertEquals(0, ft.getBusinessCriticalitySize());
	}
	...
	public void NoFunctionalFitOrNoDescription() {
		...
		//there should be a problem factsheet since it there is no description
		assertEquals(1, ft.getFunctionalFitSize());
		...
		assertEquals(1, ft2.getFunctionalFitSize());
	...
	public void hasFunctionalFitAndDescription() {
		...
		//there shouldn't be a problem factsheet
		assertEquals(0, ft.getFunctionalFitSize());
	}
	...
	public void noTechnicalFitOrNoDescription() {
		...
		//there should be a problem factsheet since it there is no description
		assertEquals(1, ft.getTechnicalFitSize());
		...
		assertEquals(1, ft2.getTechnicalFitSize());
	...
	public void hasTechnicalFitAndDescription() {
		...
		//there shouldn't be a problem factsheet
		assertEquals(0, ft.getTechnicalFitSize());
	}
	...
	public void approvedQualitySeal() {
		...
		//there shouldn't be a problem factsheet
		assertEquals(0, ft.getQualitySealSize());
	}
	...
	public void noModelStatus() {
		...
		assertEquals(1, ft.getModelStatusSize());
	}
	...
	public void readyModelStatus() {
		...
		assertEquals(0, ft.getModelStatusSize());
	}
	...
	public void lowerScore() {
		...
		assertEquals(1, ft.getScoreSize());
	}
	...
	public void equalScore() {
		...
		assertEquals(0, ft.getScoreSize());
	}
	...
	public void noDocuments() {
		...
		assertEquals(1, ft.getDocumentsSize());
	}
	...
	public void hasDocument() {
		...
		//there shouldn't be a problem factsheet since it has a relation
		assertEquals(0, ft.getDocumentsSize());
	}
	...
	public void noLifecycle() {
		...
		assertEquals(1, ft.getLifecycleSize());
		...
		//there should be a problem factsheet since there's no lifecycle
		assertEquals(1, ft1.getLifecycleSize());
	...
	public void hasLifecycle() {
		...
		assertEquals(0, ft.getLifecycleSize());
	}
	...
	public void NoBusinessValueOrRisk() {
		...
		assertEquals(1, ft.getBusinessValueRiskSize());
		...
		assertEquals(1, ft2.getBusinessValueRiskSize());
	...
	public void hasBusinessValueAndRisk() {
		...
		assertEquals(0, ft.getBusinessValueRiskSize());
	}
