...
public class VdlParserUtil extends GeneratedParserUtilBase {
    ...
    public static boolean consumeBlock(PsiBuilder builder_, @SuppressWarnings("UnusedParameters") int level) {
        ...
        do {
            ...
            i += type == VdlTypes.LBRACE ? 1 : type == VdlTypes.RBRACE ? -1 : 0;
    ...
    public static boolean prevIsArrayType(@NotNull PsiBuilder builder_, @SuppressWarnings("UnusedParameters") int level) {
        ...
        return type == VdlTypes.ARRAY_OR_SLICE_TYPE || type == VdlTypes.MAP_TYPE;
    }
    ...
    public static boolean keyOrValueExpression(@NotNull PsiBuilder builder_, int level) {
        ...
        boolean r = VdlParser.Expression(builder_, level + 1, -1);
        if (!r) r = VdlParser.LiteralValue(builder_, level + 1);
        IElementType type = r && builder_.getTokenType() == VdlTypes.COLON ? VdlTypes.KEY : VdlTypes.VALUE;
