...
{
internal class StandardShaderOutlinedGUI : ShaderGUI
{
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
		    ...
		    /*EditorGUILayout.BeginHorizontal();
                GUILayout.Label("OutlineWidth ");
		    
                outlineWidth.floatValue = GUILayout.HorizontalSlider(outlineWidth.floatValue, 0.003f, 0.3f, GUILayout.ExpandWidth(true));
                outlineWidth.floatValue = EditorGUILayout.FloatField(outlineWidth.floatValue, GUILayout.MaxWidth(1), GUILayout.ExpandWidth(false));
                EditorGUILayout.EndHorizontal();
            EditorGUILayout.Space();
            */
		    {
		        Rect r = EditorGUILayout.GetControlRect(true, 18f, EditorStyles.layerMaskField, new GUILayoutOption[0]);
		        Rect s = MaterialEditor.GetRectAfterLabelWidth(r);
                EditorGUI.LabelField(r, "Outline Width");
		        outlineWidth.floatValue = EditorGUI.Slider(s, outlineWidth.floatValue, 0.3f, 0.003f);
		    }
            {
                Rect r = EditorGUILayout.GetControlRect(true, 18f, EditorStyles.layerMaskField, new GUILayoutOption[0]);
                Rect s = MaterialEditor.GetRectAfterLabelWidth(r);
                EditorGUI.LabelField(r, "Outline Color");
                outlineColor.colorValue = EditorGUI.ColorField(s, outlineColor.colorValue);
            }
