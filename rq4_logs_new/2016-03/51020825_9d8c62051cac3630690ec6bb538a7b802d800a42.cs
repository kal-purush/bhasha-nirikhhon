...
namespace UrdfUnityTest.Parse.Xml
{
    ...
    public class RobotParserTest
    {
        ...
        {
            // TODO: Investigate file I/O for tests and use UrdfUnityTest/TestData/example.urdf
            // TODO: Perhaps using: [DeploymentItem("UrdfUnityTest\\TestData\\example.urdf")]
            //string filePath = "UrdfUnityTest\\TestData\\example.urdf";
