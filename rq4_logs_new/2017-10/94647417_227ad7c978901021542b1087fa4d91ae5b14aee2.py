# -*- coding: utf-8 -*-
#
# DI-Sensors documentation build configuration file, created by
...
htmlhelp_basename = 'DI-Sensorsdoc'
...
#intersphinx_mapping = {'gopigo3': ('http://gopigo3.readthedocs.io/en/latest/', None)}