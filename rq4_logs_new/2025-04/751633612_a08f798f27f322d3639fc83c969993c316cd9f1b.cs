...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MasterFile.MobilityEmployee", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("EmployeeId")
                        .HasName("pk_mobility_employees");

                    b.HasIndex("EmployeeNumber")
                        .HasDatabaseName("ix_mobility_employees_employee_number");

                    b.ToTable("mobility_employees", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MobilityCheckVoucherHeader", b =>
                {
                    ...
                    b.HasOne("IBS.Models.Mobility.MasterFile.MobilityEmployee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("fk_mobility_check_voucher_headers_mobility_employees_employee_");
