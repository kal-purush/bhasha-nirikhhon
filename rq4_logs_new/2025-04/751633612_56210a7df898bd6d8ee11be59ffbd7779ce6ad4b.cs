...
namespace IBS.DataAccess.Migrations
{
    ...
    [Migration("20250422063437_AddNewTableForDebitMemo")]
    partial class AddNewTableForDebitMemo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MobilityDebitMemo", b =>
                {
                    b.HasOne("IBS.Models.Filpride.AccountsReceivable.FilprideServiceInvoice", "ServiceInvoice")
                        ...
                        .HasForeignKey("ServiceInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_mobility_debit_memos_filpride_service_invoices_service_invo");
