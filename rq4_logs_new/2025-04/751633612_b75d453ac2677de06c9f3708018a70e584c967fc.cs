...
namespace IBS.DataAccess.Migrations
{
    ...
    [Migration("20250416041342_RemoveForeignKeyInMobilityCOSModel")]
    partial class RemoveForeignKeyInMobilityCOSModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MobilityCOSAppointedSupplier", b =>
                {
                    b.Property<int>("SequenceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("SequenceId")
                        .HasName("pk_mobility_cos_appointed_suppliers");

                    b.HasIndex("CustomerOrderSlipId")
                        .HasDatabaseName("ix_mobility_cos_appointed_suppliers_customer_order_slip_id");

                    b.HasIndex("PurchaseOrderId")
                        .HasDatabaseName("ix_mobility_cos_appointed_suppliers_purchase_order_id");

                    b.HasIndex("SupplierId")
                        .HasDatabaseName("ix_mobility_cos_appointed_suppliers_supplier_id");

                    b.ToTable("mobility_cos_appointed_suppliers", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MobilityCustomerOrderSlip", b =>
                {
                    ...
                    b.Property<int?>("MobilityStationStationId")
                        .HasColumnType("integer")
                        .HasColumnName("mobility_station_station_id");
                    ...
                    b.HasIndex("MobilityStationStationId")
                        .HasDatabaseName("ix_mobility_customer_order_slips_mobility_station_station_id");
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MobilityMainCOS", b =>
                {
                    b.Property<int>("CustomerOrderSlipId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("CustomerOrderSlipId")
                        .HasName("pk_mobility_main_cos");

                    b.HasIndex("CommissioneeId")
                        .HasDatabaseName("ix_mobility_main_cos_commissionee_id");

                    b.HasIndex("CustomerId")
                        .HasDatabaseName("ix_mobility_main_cos_customer_id");

                    b.HasIndex("CustomerOrderSlipNo")
                        .HasDatabaseName("ix_mobility_main_cos_customer_order_slip_no");

                    b.HasIndex("Date")
                        .HasDatabaseName("ix_mobility_main_cos_date");

                    b.HasIndex("HaulerId")
                        .HasDatabaseName("ix_mobility_main_cos_hauler_id");

                    b.HasIndex("PickUpPointId")
                        .HasDatabaseName("ix_mobility_main_cos_pick_up_point_id");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_mobility_main_cos_product_id");

                    b.HasIndex("PurchaseOrderId")
                        .HasDatabaseName("ix_mobility_main_cos_purchase_order_id");

                    b.HasIndex("SupplierId")
                        .HasDatabaseName("ix_mobility_main_cos_supplier_id");

                    b.ToTable("mobility_main_cos", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MobilityCOSAppointedSupplier", b =>
                {
                    b.HasOne("IBS.Models.Mobility.MobilityMainCOS", "CustomerOrderSlip")
                        .WithMany("AppointedSuppliers")
                        .HasForeignKey("CustomerOrderSlipId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_mobility_cos_appointed_suppliers_mobility_main_cos_customer");
                    ...
                    b.HasOne("IBS.Models.Mobility.MobilityPurchaseOrder", "PurchaseOrder")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_mobility_cos_appointed_suppliers_mobility_purchase_orders_p");
                    ...
                    b.HasOne("IBS.Models.Mobility.MasterFile.MobilitySupplier", "Supplier")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_mobility_cos_appointed_suppliers_mobility_suppliers_supplie");
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MobilityCustomerOrderSlip", b =>
                {
                    ...
                    b.HasOne("IBS.Models.Mobility.MasterFile.MobilityStation", "MobilityStation")
                        .WithMany()
                        .HasForeignKey("MobilityStationStationId")
            ...
            modelBuilder.Entity("IBS.Models.Mobility.MobilityMainCOS", b =>
                {
                    b.HasOne("IBS.Models.Mobility.MasterFile.MobilitySupplier", "Commissionee")
                        .WithMany()
                        .HasForeignKey("CommissioneeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_mobility_main_cos_mobility_suppliers_commissionee_id");
                    ...
                    b.HasOne("IBS.Models.Mobility.MasterFile.MobilityCustomer", "Customer")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_mobility_main_cos_mobility_customers_customer_id");

                    b.HasOne("IBS.Models.Mobility.MasterFile.MobilitySupplier", "Hauler")
                        .WithMany()
                        .HasForeignKey("HaulerId")
                        .HasConstraintName("fk_mobility_main_cos_mobility_suppliers_hauler_id");

                    b.HasOne("IBS.Models.Mobility.MasterFile.MobilityPickUpPoint", "PickUpPoint")
                        .WithMany()
                        .HasForeignKey("PickUpPointId")
                        .HasConstraintName("fk_mobility_main_cos_mobility_pick_up_points_pick_up_point_id");
                    ...
                    b.HasOne("IBS.Models.MasterFile.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mobility_main_cos_products_product_id");

                    b.HasOne("IBS.Models.Mobility.MobilityPurchaseOrder", "PurchaseOrder")
                        .WithMany()
                        .HasForeignKey("PurchaseOrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_mobility_main_cos_mobility_purchase_orders_purchase_order_id");

                    b.HasOne("IBS.Models.Mobility.MasterFile.MobilitySupplier", "Supplier")
                        .WithMany()
                        .HasForeignKey("SupplierId")
                        .HasConstraintName("fk_mobility_main_cos_mobility_suppliers_supplier_id");
