...
public static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        rootCommand.SetHandler(GenerateBenchmarkCode, numberOption, outputOption);

        return await rootCommand.InvokeAsync(args);
    }

    static void GenerateBenchmarkCode(int numberOfRequests, DirectoryInfo outputDir)
    {
    ...
    static void GenerateRequestsAndResponses(int count, string outputDir)
    {
    ...
    static void GenerateRequestHandlers(int count, string outputDir)
    {
        var sb = new StringBuilder();
        AddFileHeader(sb);
    ...
    static void GenerateNotificationsAndHandlers(int requestCount, string outputDir)
    {
    ...
    static void AddFileHeader(StringBuilder sb)
    {
