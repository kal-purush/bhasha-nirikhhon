...
import {generateDownloadFilenamePrefixByStudies, generateDownloadFilenamePrefixByStudyIds} from "./FilenameUtils";
...
describe('FilenameUtils', () => {
    describe("generateDownloadFilenamePrefixByStudyIds", () => {
        ...
        it('Generates a fixed prefix for with actual study name for multiple studies input', () => {
            assert.equal(generateDownloadFilenamePrefixByStudyIds(["study1", "study2"]), "combined_study_");
        });
    });
    ...
    describe("generateDownloadFilenamePrefixByStudies", () => {
        ...
        it('Generates a fixed prefix for with actual study name for multiple studies input', () => {
            ...
            assert.equal(generateDownloadFilenamePrefixByStudies(multipleStudies), "combined_study_");
        });
    });
});
