...
{    
    ...
    public class Detail : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The max version of the package in which the vulnerability exists. This field can be used as a
        /// filter in list requests.</summary>
    ...
    public class Note : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The name of the note in the form "providers/{provider_id}/notes/{NOTE_ID}"</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("name")]
        public virtual string Name { get; set; } 
