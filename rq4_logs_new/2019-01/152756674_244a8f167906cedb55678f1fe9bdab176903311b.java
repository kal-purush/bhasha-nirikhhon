...
public class Baliff extends NPC {

	// texture sheets
		private static final String MOVEMENT_SPRITE_SHEET = "characters//baliff.png";
		private static final String DEATH_SPRITE_SHEET = "characters//baliff.png";
		private static final String COMBAT_SPRITE_SHEET = "characters//baliff.png";
	...
	public Baliff(GameWorld gameWorld, TiledMapTileLayer accessibleTiles, float startX, float startY, String name, 
