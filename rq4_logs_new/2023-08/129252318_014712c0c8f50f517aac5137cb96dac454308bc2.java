...
public class EmptyObject implements JEVisObject {

    private static EmptyObject instance = null;

    public static EmptyObject getInstance() {
        if (instance == null) instance = new EmptyObject();
    ...
    public String getName() {
        return I18n.getInstance().getString("plugin.action.emptyobject.name");
    }
