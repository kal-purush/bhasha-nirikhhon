...
namespace Confab.Modules.Tickets.Core.Services
{
    internal class TicketService : ITicketService
    {
        ...
        public async Task PurchaseAsync(Guid conferenceId, Guid userId)
        {
            ...
            var ticketSale = await _ticketSaleRepository.GetCurrencyForConferenceAsync(conferenceId, now);
            ...
            _logger.LogInformation($"Ticket with ID: '{ticket.Id}' was generated fot the conference: " +
