...
describe("ExtendedPublicKeyService", () => {
	test("#fromMnemonic", async () => {
		await expect(subject.fromMnemonic("excess behave track soul table wear ocean cash stay nature item turtle palm soccer lunch horror start stumble month panic right must lock dress")).resolves.toBe(
