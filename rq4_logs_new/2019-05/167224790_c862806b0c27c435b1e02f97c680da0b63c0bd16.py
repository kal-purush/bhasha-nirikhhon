...
sites_dicts = [ 
    ...
    {   
        ...
        'elevation': 5,
        'timezone': 'Etc/GMT+8',
        'extra_parameters': '{"network": "NOAA SURFRAD", "observation_interval_length": 5}',
    },  
    {   
        ...
        'elevation': 6,
        'timezone': 'Etc/GMT+8',
        'extra_parameters': '{"network": "NOAA SOLRAD", "observation_interval_length": 1}',
    },  
    {   
        'name': 'site4',
        'latitude': 4,
...
def site_objects_pram():
    return [Site.from_dict(site) for site in sites_list]
