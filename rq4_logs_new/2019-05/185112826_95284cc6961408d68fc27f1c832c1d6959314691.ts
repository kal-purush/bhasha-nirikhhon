...
export class GenericAsset {
     ...
     */
    create(options: IAssetOptions): SubmittableExtrinsic<Promise<Hash>, Promise<() => any>> {
     ...
     */
    get getTotalIssuance(): QueryableStorageFunction<Promise<BN>, Promise<() => any>> {
