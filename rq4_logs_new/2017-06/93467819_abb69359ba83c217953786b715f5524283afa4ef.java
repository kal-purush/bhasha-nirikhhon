...
/**
 * Created by Foutas on 2017/6/23.
 */
import javax.swing.*;
...
public class HTMLView extends JFrame implements HyperlinkListener {
        ...
        public HTMLView() throws Exception {
                ...
                //设置是显示网页 html 文件,可选项  
                editorPane.setContentType("D:\\Ccode\\Offline_api\\baidumapv2.0.3\\demo.html");
                //设置成只读，如果是可编辑，你会看到显示的样子也是不一样的，true显示界面  
                editorPane.setEditable(false);
                //要能响应网页中的链接，则必须加上超链监听器  
                editorPane.addHyperlinkListener(this);
                String path = "file:///D:/Ccode/Offline_api/baidumapv2.0.3/demo.html";
                try {
