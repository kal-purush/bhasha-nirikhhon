...
class TestStaticDependency(unittest.TestCase):
    ...
    def test_get_tag_css(self):
        dependency = dependencies.StaticDependency('name', 'version', css_path='css_path')
        result = dependency._get_tag('css')
        self.assertEqual(result, '<link rel="stylesheet" href="/static/name/css_path"  />')
    ...
    def test_get_tag_integrity(self):
        dependency = dependencies.StaticDependency(
            'name', 'version', js_path='js_path', js_integrity='js_integrity', cdn_url='{npm_name}@{version}/{path}'
        )
        result = dependency._get_tag('js')
        self.assertEqual(
            result,
    ...
    def test_default_debug_path_converter(self):
        result = dependencies.StaticDependency.default_debug_path_converter('test/dependency/path.min.js')
    ...
    def test_get_url_debug(self):
        dependency = dependencies.StaticDependency('name', 'version', js_path='js_path.min.js')
