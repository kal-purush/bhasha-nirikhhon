...
namespace Abp.EntityHistory
{
    public static class EntitySnapshotManagerExtensions
    {
        ...
        /// </summary>
        public static async Task<EntityHistorySnapshot> GetSnapshotAsync<TEntity>(this IEntitySnapshotManager entitySnapshotManager, int id, DateTime snapshotTime)
