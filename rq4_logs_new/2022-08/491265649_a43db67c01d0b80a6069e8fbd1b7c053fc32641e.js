    ...
    <Box style={{ textAlign: 'center', marginBottom: '20px' }}>
      <Box>
        <div className="home" style={homeStyle}>
          ...
          (the developer) a easy way to test and develope your own framework.
          <h4>How to deploay workload in Mini Cluster:</h4>
          There are planty of frameworks to deploy workload on 'Mini Cluster'. As example we will use 'mesos-compose' 
