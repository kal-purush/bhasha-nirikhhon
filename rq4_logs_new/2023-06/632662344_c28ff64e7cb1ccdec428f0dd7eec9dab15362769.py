...
margin.pack()
text_id = Label(root, bg='#ffc8dd', text='vamo se beijar quando?',
                fg='#590d22', font=('Montserrat', 24, 'bold'))
text_id.pack()
button_1 = tk.Button(root, text='Nunca', bg='#ffb3c1', command=denied,
                     relief=RIDGE, bd=3, font=('Montserrat', 8, 'bold'))
button_1.pack()
root.bind('<Motion>', move_button_1)
button_2 = tk.Button(root, text='Agora, vem cá', bg='#ffb3c1', relief=RIDGE,
