...
namespace SampleCompany.SamplePublisher
{
    public static class Program
    {
        ...
        {
            Console.WriteLine("SampleCompany OPC UA Sample Publisher");
        ...
        private static PublishedDataSetDataType CreatePublishedDataSetSimple()
        {
            ...
            publishedDataSetSimple.DataSetMetaData.ConfigurationVersion = new ConfigurationVersionDataType() {
                MinorVersion = ConfigurationVersionUtils.CalculateVersionTime(timeOfConfiguration_),
                MajorVersion = ConfigurationVersionUtils.CalculateVersionTime(timeOfConfiguration_)
            };
        ...
        private static readonly DateTime timeOfConfiguration_ = new DateTime(2021, 6, 1, 0, 0, 0, DateTimeKind.Utc);
        #endregion
    }
}