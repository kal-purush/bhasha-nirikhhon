...
import { RunnerDestroyError, RunnerExecuteError, RunnerInitError, RunnerNotInitError, WorkerNotInitError } from './runner-errors';
...
export const CODE_TO_ERROR_MAP: Record<number, Constructor<WorkerRunnerError, [IWorkerRunnerErrorConfig]>> = {
    ...
    [WorkerRunnerErrorCode.RUNNER_NOT_INIT]: RunnerNotInitError,
