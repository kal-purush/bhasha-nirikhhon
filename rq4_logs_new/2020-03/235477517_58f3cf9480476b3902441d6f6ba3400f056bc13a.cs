...
{
    public struct MyMovingPlantState
    {
        public PhysicsMoverState MoverState;
        public float DirectorTime;
    }

    public class MyMovablePlantAnim : MonoBehaviour, IMoverController
    {
        ...
        public bool initializeOnSun = false;
        ...
        public void UpdateMovement(out Vector3 goalPosition, out Quaternion goalRotation, float deltaTime)
        {
            ...
            if (timer >= runTime)
            {
                transform.GetComponent<KinematicCharacterController.PhysicsMover>().enabled = false;
                enabled = false;
            }
