...
if __name__ == '__main__':
    sim_data_64d = torch.rand(32, 50, 100)
    # trans = STNkd(k=64)
    # out = trans(sim_data_64d)
    # print('stn64d', out.size())
    # print('loss', feature_transform_regularizer(out))

    pointfeat = PointNetfeat_lite(feat_dim=50, hidden_size=768, global_feat=False)
    out, _, _ = pointfeat(sim_data_64d)
    print('point feat', out.size())
    pointfeat = PointNetfeat_lite(feat_dim=50, hidden_size=768, global_feat=True)
    out, _, _ = pointfeat(sim_data_64d)
    print('point feat', out.size())