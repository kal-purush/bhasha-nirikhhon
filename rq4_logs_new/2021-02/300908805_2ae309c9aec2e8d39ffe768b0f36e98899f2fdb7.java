...
import com.future.tailormade.command.order.impl.AcceptTailorOrderCommandImpl;
...
public class AcceptTailorOrderCommandImplTest extends BaseTest {

    @InjectMocks
    private AcceptTailorOrderCommandImpl command;
    ...
    public void acceptTailorOrder_success() {
        ...
        Order expectedOrder = createOrder(OrderStatusEnum.Accepted);
    ...
    private AcceptTailorOrderRequest createAcceptTailorOrderRequest() {
        return AcceptTailorOrderRequest.builder()
                .id(ORDER_ID)
                .tailorId(TAILOR_ID)
                .build();
    }
