package ru.epam.javacore.lesson_23_relational_db.homework.application;

import static java.util.Collections.singletonList;
import static ru.epam.javacore.lesson_23_relational_db.homework.cargo.domain.CargoField.NAME;
import static ru.epam.javacore.lesson_23_relational_db.homework.cargo.domain.CargoField.WEIGHT;
import static ru.epam.javacore.lesson_23_relational_db.homework.common.solutions.search.OrderType.ASC;
import static ru.epam.javacore.lesson_23_relational_db.homework.common.solutions.search.OrderType.DESC;
import static ru.epam.javacore.lesson_23_relational_db.homework.storage.initor.StorageInitorFactory.getStorageInitor;

import ru.epam.javacore.lesson_23_relational_db.homework.application.serviceholder.ServiceHolder;
import ru.epam.javacore.lesson_23_relational_db.homework.application.serviceholder.StorageType;
import ru.epam.javacore.lesson_23_relational_db.homework.cargo.domain.Cargo;
import ru.epam.javacore.lesson_23_relational_db.homework.cargo.domain.CargoField;
...
import ru.epam.javacore.lesson_23_relational_db.homework.common.solutions.search.OrderType;
import ru.epam.javacore.lesson_23_relational_db.homework.common.solutions.utils.CollectionUtils;
import ru.epam.javacore.lesson_23_relational_db.homework.reporting.ReportDefaultService;
import ru.epam.javacore.lesson_23_relational_db.homework.reporting.ReportService;
import ru.epam.javacore.lesson_23_relational_db.homework.storage.initor.InitStorageType;
