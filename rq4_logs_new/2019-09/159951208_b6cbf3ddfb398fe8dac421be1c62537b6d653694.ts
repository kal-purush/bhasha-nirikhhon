...
describe("randomGaussianNumberInRange", () => {
  it("should return a random number in a range of two positive numbers", () => {
    for (let i = 0; i < 50; i++) {
      const randomNumber: number = randomGaussianNumberInRange(1, 2000);
  ...
  it("should return a random number in a range of two negative numbers", () => {
    for (let i = 0; i < 50; i++) {
      const randomNumber: number = randomGaussianNumberInRange(-2000, -1);
  ...
  it("should return a random number in a range of one negative and one positive number", () => {
    for (let i = 0; i < 50; i++) {
      const randomNumber: number = randomGaussianNumberInRange(-2000, 2000);
