;(function (angular, contentUpdate, contentPackageSwitcher, undefined) {
    ...
    angular.module( 'cqAppNavigation', ['ionic', 'btford.phonegap.ready'] )
        .controller( 'AppNavigationController', ['$scope', '$window', '$rootScope', '$location', '$timeout', 'phonegapReady', '$rootElement', '$ionicSideMenuDelegate', '$ionicTabsDelegate',
            function( $scope, $window, $rootScope, $location, $timeout, phonegapReady, $rootElement, $ionicSideMenuDelegate, $ionicTabsDelegate) {
                ...
                $scope.onInfinite = function() {
                    $scope.$broadcast("onInfinite", 'no message');
                ...
                $scope.go = function( path, trackingTitle, transitionDirection ) {
                    ...
                    $window.ga('set', 'screenName', (trackingTitle || path));
                    $window.ga('send', 'screenview');
                    $window.ga('send', 'event', '[nav] app navigated to: [' + (trackingTitle || path) + '].');
                };
