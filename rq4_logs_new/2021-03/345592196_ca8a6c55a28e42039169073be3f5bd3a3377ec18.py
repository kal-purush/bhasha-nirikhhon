...
class SmartSaveUI(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowFlags(self.windowFlags() ^
                            QtCore.Qt.WindowsContextHelpButtonHint)
        self.create_ui()
    ...
    def _create_filename_ui(self):
        ...
        self.ver_sbx.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMius)
    ...
    def _create_filename_headers(self):
        ...
        self.ver_header_lbl = QtWidgets.Qlabel("Task")
...
class SceneFile(object):
    ...
    def __init__(self, path):
        ...
        if not path and scene:
            path = scene
        if not scene and not path:
            log.warning("Unable to initialise SceneFile object from a new scene.  "
    ...
    def _init_from_path(self, path):
        ...
        self.ext = path.ext
        self.descriptor, self.task, self.ver = path.stripext().split("_")
